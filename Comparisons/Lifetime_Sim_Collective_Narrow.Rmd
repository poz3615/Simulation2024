...
N_df.a <- data.frame(
  ...
  Median = c(exp(median(unlist(lapply(N_param_list1[[1]], function(matrix) matrix[, 1])))), 
           exp(median(unlist(lapply(N_param_list2[[1]], function(matrix) matrix[, 1])))), 
           exp(median(unlist(lapply(N_param_list3[[1]], function(matrix) matrix[, 1])))), 
           exp(median(unlist(lapply(N_param_list4[[1]], function(matrix) matrix[, 1])))), 
           exp(median(unlist(lapply(N_param_list5[[1]], function(matrix) matrix[, 1]))))), 
...
N_df.b <- data.frame(
  x = factor(c("Individual Exp Data, Exp Model", "Mean Exp Data, Exp Model", "Individual Inverse Exp Data, Trunc Norm Model", 
               "Mean Inverse Exp Data, Trunc Norm Model", "Inverse Mean Exp Data, Trunc Norm Model")), 
  Median = c(median(unlist(lapply(N_param_list1[[2]], function(matrix) matrix[, 1]))), 
           median(unlist(lapply(N_param_list2[[2]], function(matrix) matrix[, 1]))), 
           median(unlist(lapply(N_param_list3[[2]], function(matrix) matrix[, 1]))), 
           median(unlist(lapply(N_param_list4[[2]], function(matrix) matrix[, 1]))), 
           median(unlist(lapply(N_param_list5[[2]], function(matrix) matrix[, 1])))), 
...
N_df.c <- data.frame(
  x = factor(c("Individual Exp Data, Exp Model", "Mean Exp Data, Exp Model", "Individual Inverse Exp Data, Trunc Norm Model", 
               "Mean Inverse Exp Data, Trunc Norm Model", "Inverse Mean Exp Data, Trunc Norm Model")), 
  Median = c((median(unlist(lapply(N_param_list1[[3]], function(matrix) matrix[, 1])))), 
...
df.a.wb.n <- data.frame(
  ...
  Median = c(exp(median(unlist(lapply(Weibull_N_param_list1[[1]], function(matrix) matrix[, 1])))), 
           exp(median(unlist(lapply(Weibull_N_param_list2[[1]], function(matrix) matrix[, 1])))), 
           exp(median(unlist(lapply(Weibull_N_param_list3[[1]], function(matrix) matrix[, 1])))), 
           exp(median(unlist(lapply(Weibull_N_param_list4[[1]], function(matrix) matrix[, 1])))), 
           exp(median(unlist(lapply(Weibull_N_param_list5[[1]], function(matrix) matrix[, 1])))), 
           exp(median(unlist(lapply(Weibull_N_param_list6[[1]], function(matrix) matrix[, 1]))))), 
...
df.b.wb.n <- data.frame(
  x = factor(c("Individual WB Data, Exp Model", "Mean WB Data, Exp Model", "Individual Inverse WB Data, Trunc Norm Model", 
               "Mean Inverse WB Data, Trunc Norm Model", "Inverse Mean WB Data, Trunc Norm Model", "WB Data, WB Model")), 
  Median = c(median(unlist(lapply(Weibull_N_param_list1[[2]], function(matrix) matrix[, 1]))), 
           median(unlist(lapply(Weibull_N_param_list2[[2]], function(matrix) matrix[, 1]))), 
           median(unlist(lapply(Weibull_N_param_list3[[2]], function(matrix) matrix[, 1]))), 
           median(unlist(lapply(Weibull_N_param_list4[[2]], function(matrix) matrix[, 1]))), 
           median(unlist(lapply(Weibull_N_param_list5[[2]], function(matrix) matrix[, 1]))), 
           median(unlist(lapply(Weibull_N_param_list6[[2]], function(matrix) matrix[, 1])))), 
...
df.c.wb.n <- data.frame(
  x = factor(c("Individual WB Data, Exp Model", "Mean WB Data, Exp Model", "Individual Inverse WB Data, Trunc Norm Model", 
               "Mean Inverse WB Data, Trunc Norm Model", "Inverse Mean WB Data, Trunc Norm Model", "WB Data, WB Model")), 
  Median = c((median(unlist(lapply(Weibull_N_param_list1[[3]], function(matrix) matrix[, 1])))), 
           (median(unlist(lapply(Weibull_N_param_list2[[3]], function(matrix) matrix[, 1])))), 
           (median(unlist(lapply(Weibull_N_param_list3[[3]], function(matrix) matrix[, 1])))), 
           (median(unlist(lapply(Weibull_N_param_list4[[3]], function(matrix) matrix[, 1])))), 
           (median(unlist(lapply(Weibull_N_param_list5[[3]], function(matrix) matrix[, 1])))), 
           (median(unlist(lapply(Weibull_N_param_list6[[3]], function(matrix) matrix[, 1]))))), 
...
wb.wb.13.n <- qqPlot(Weibull_N_data.list[[100]]$trait[Weibull_N_data.list[[100]]$T  == 13], 
       ...
       param.list = list(scale = 1/(exp(mean(unlist(lapply(Weibull_N_param_list6[[1]], function(matrix) matrix[, 1])))) * (13 -
                               (mean(unlist(lapply(Weibull_N_param_list6[[2]], function(matrix) matrix[, 1])))))^2 +
                               mean(unlist(lapply(Weibull_N_param_list6[[3]], function(matrix) matrix[, 1]))))/log(2)^(1/mean(unlist(lapply(Weibull_N_param_list6[[5]], function(matrix) matrix[, 1])))), 
                         shape = mean(unlist(lapply(Weibull_N_param_list6[[5]], function(matrix) matrix[, 1])))), plot.it = FALSE)
...
boxplot.df_N <- data.frame(
  Method = factor(c(rep("Individual Exp Data, Exp Model", 250), rep("Mean Exp Data, Exp Model", 250), rep("Individual Inverse Exp Data, Trunc Norm Model", 250), rep("Mean Inverse Exp Data, Trunc Norm Model", 250), rep("Inverse Mean Exp Data, Trunc Norm Model", 250)), 
                  levels = c("Individual Exp Data, Exp Model", "Mean Exp Data, Exp Model", "Individual Inverse Exp Data, Trunc Norm Model", "Mean Inverse Exp Data, Trunc Norm Model", "Inverse Mean Exp Data, Trunc Norm Model")), 
...
wb.mean.param.curve.rmse.n <- data.frame(
  RMSE = 
    c(sqrt(mean((1/ind.wb.n(xseq) - 1/f(xseq))^2)), 
  sqrt(mean((1/mean.wb.n(xseq) - 1/f(xseq))^2)), 
  sqrt(mean((1/inv.wb.n(xseq) - 1/f(xseq))^2)), 
  sqrt(mean((1/mean.inv.wb.n(xseq) - 1/f(xseq))^2)), 
  sqrt(mean((1/inv.mean.wb.n(xseq) - 1/f(xseq))^2)), 
  sqrt(mean((1/ind.wb.wb.n(xseq) - 1/f(xseq))^2)))
)
...
exp.mean.curve.rmse.n <- data.frame(
  RMSE = c(sqrt(mean((N_mean.xdf1$avg.value.inv - 1/N_mean.xdf1$true_curve)^2)), 
  sqrt(mean((N_mean.xdf2$avg.value.inv - 1/N_mean.xdf2$true_curve)^2)), 
  sqrt(mean((N_mean.xdf3$avg.value.inv - 1/N_mean.xdf3$true_curve)^2)), 
  sqrt(mean((N_mean.xdf4$avg.value.inv - 1/N_mean.xdf4$true_curve)^2)), 
  sqrt(mean((N_mean.xdf5$avg.value.inv - 1/N_mean.xdf5$true_curve)^2)))
)
...
wb.mean.curve.rmse.n <- data.frame(
  RMSE = 
    c(sqrt(mean((mean.xdf1_W_N$avg.value.inv - log(2)/mean.xdf1_W_N$true_curve)^2)), 
  sqrt(mean((mean.xdf2_W_N$avg.value.inv - log(2)/mean.xdf2_W_N$true_curve)^2)), 
  sqrt(mean((mean.xdf3_W_N$avg.value.inv - 1/mean.xdf3_W_N$true_curve)^2)), 
  sqrt(mean((mean.xdf4_W_N$avg.value.inv - 1/mean.xdf4_W_N$true_curve)^2)), 
  sqrt(mean((mean.xdf5_W_N$avg.value.inv - 1/mean.xdf5_W_N$true_curve)^2)), 
  sqrt(mean((mean.xdf6_W_N$avg.value.inv - log(2)/mean.xdf6_W_N$true_curve)^2)))
