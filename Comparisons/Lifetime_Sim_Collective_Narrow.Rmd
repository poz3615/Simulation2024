...
N_a.plot <- ggplot(N_df.a, aes(x, Mean))+
  geom_point(col=cividis(3)[1]) + geom_linerange(aes(ymin = lower, ymax = upper), col = cividis(3)[2])+labs(title="A",x="Method")+
...
N_b.plot <- ggplot(N_df.b, aes(x, Mean))+
  geom_point(col=cividis(3)[1])+ geom_linerange(aes(ymin = lower, ymax = upper), col = cividis(3)[2])+labs(title="B",x="Method")+
  geom_hline(yintercept = Topt, linetype = "dashed", color = cividis(3)[3])+
  theme_classic()+
  coord_flip()
N_b.plot
```
...
N_c.plot <- ggplot(N_df.c, aes(x, Mean))+
  geom_point(col=cividis(3)[1])+ geom_linerange(aes(ymin = lower, ymax = upper), col = cividis(3)[2])+labs(title="C",x="Method")+
...
log_N_a.plot <- ggplot(log_N_df.a, aes(x, log(Mean)))+
  geom_point(col=cividis(3)[1]) + geom_linerange(aes(ymin = log(lower), ymax = log(upper)), col = cividis(3)[2])+labs(title="A",x="Method")+
...
log_N_b.plot <- ggplot(log_N_df.b, aes(x, log(Mean)))+
  geom_point(col=cividis(3)[1])+ geom_linerange(aes(ymin = log(lower), ymax = log(upper)), col = cividis(3)[2])+labs(title="B",x="Method")+
  geom_hline(yintercept = log(Topt), linetype = "dashed", color = cividis(3)[3])+
  theme_classic()+
  coord_flip()
log_N_b.plot
```
...
log_N_c.plot <- ggplot(log_N_df.c, aes(x, log(Mean)))+
  geom_point(col=cividis(3)[1])+ geom_linerange(aes(ymin = log(lower), ymax = log(upper)), col = cividis(3)[2])+labs(title="C",x="Method")+
...
a.wb.plot.n <- ggplot(df.a.wb.n, aes(x, Mean))+
  geom_point(col=plasma(3)[1]) + geom_linerange(aes(ymin = lower, ymax = upper), col = plasma(3)[2])+labs(title="A",x="Method")+
  geom_hline(yintercept = true.exp.a, linetype = "dashed", color = plasma(3)[3])+
  theme_classic()+
  coord_flip()
a.wb.plot.n
```
...
b.wb.plot.n <- ggplot(df.b.wb.n, aes(x, Mean))+
  geom_point(col=plasma(3)[1])+ geom_linerange(aes(ymin = lower, ymax = upper), col = plasma(3)[2])+labs(title="B",x="Method")+
  geom_hline(yintercept = true.exp.b, linetype = "dashed", color = plasma(3)[3])+
  theme_classic()+
  coord_flip()
b.wb.plot.n
```
...
c.wb.plot.n <- ggplot(df.c.wb.n, aes(x, Mean))+
  geom_point(col=plasma(3)[1])+ geom_linerange(aes(ymin = lower, ymax = upper), col = plasma(3)[2])+labs(title="C",x="Method")+
  geom_hline(yintercept = true.exp.c, linetype = "dashed", color = plasma(3)[3])+
  theme_classic()+
  coord_flip()
c.wb.plot.n
```
...
a.wb.log.plot.n <- ggplot(df.a.wb.log.n, aes(x, log(Mean)))+
  geom_point(col=plasma(3)[1]) + geom_linerange(aes(ymin = log(lower), ymax = log(upper)), col = plasma(3)[2])+labs(title="A",x="Method")+
...
b.wb.log.plot.n <- ggplot(df.b.wb.log.n, aes(x, log(Mean)))+
  geom_point(col=plasma(3)[1])+ geom_linerange(aes(ymin = log(lower), ymax = log(upper)), col = plasma(3)[2])+labs(title="B",x="Method")+
  geom_hline(yintercept = log(true.exp.b), linetype = "dashed", color = plasma(3)[3])+
  theme_classic()+
  coord_flip()
b.wb.log.plot.n
```
...
c.wb.log.plot.n <- ggplot(df.c.wb.log.n, aes(x, log(Mean)))+
  geom_point(col=plasma(3)[1])+ geom_linerange(aes(ymin = log(lower), ymax = log(upper)), col = plasma(3)[2])+labs(title="C",x="Method")+
...
a.compare.plot.n <- ggplot(df.a.compare.n, aes(x, Mean))+
  geom_point(col= viridis(3)[1]) + geom_linerange(aes(ymin = lower, ymax = upper), col = viridis(3)[2])+labs(title="A",x="Method")+
  geom_hline(yintercept = 0, linetype = "dashed", color = viridis(3)[3])+
  theme_classic()+
  #ylim(-0.002,0.002)+
  coord_flip()
a.compare.plot.n
...
b.compare.plot.n <- ggplot(df.b.compare.n, aes(x, Mean))+
  geom_point(col= viridis(3)[1]) + geom_linerange(aes(ymin = lower, ymax = upper), col = viridis(3)[2])+labs(title="B",x="Method")+
  geom_hline(yintercept = 0, linetype = "dashed", color = viridis(3)[3])+
  theme_classic()+
  ylim(-0.16,0.16)+
  coord_flip()
...
c.compare.plot.n <- ggplot(df.c.compare.n, aes(x, Mean))+
  geom_point(col=viridis(3)[1]) + geom_linerange(aes(ymin = lower, ymax = upper), col = viridis(3)[2])+labs(title="C",x="Method")+
  geom_hline(yintercept = 0, linetype = "dashed", color = viridis(3)[3])+
  theme_classic()+
  ylim(-0.95,0.95)+
  coord_flip()
...
ind.exp.n<-function(x){
  (exp(mean(unlist(lapply(N_param_list1[[1]], function(matrix) matrix[, 1]))))*(x-
         mean(unlist(lapply(N_param_list1[[2]], function(matrix) matrix[, 1]))))^2 +
         mean(unlist(lapply(N_param_list1[[3]], function(matrix) matrix[, 1]))))
}

# MEAN EXP DATA EXP MODEL
mean.exp.n<-function(x){
  (exp(mean(unlist(lapply(N_param_list2[[1]], function(matrix) matrix[, 1]))))*(x-
         mean(unlist(lapply(N_param_list2[[2]], function(matrix) matrix[, 1]))))^2 +
         mean(unlist(lapply(N_param_list2[[3]], function(matrix) matrix[, 1]))))
}

# INV EXP DATA EXP MODEL
inv.exp.n<-function(x){
  (exp(mean(unlist(lapply(N_param_list3[[1]], function(matrix) matrix[, 1]))))*(x-
         mean(unlist(lapply(N_param_list3[[2]], function(matrix) matrix[, 1]))))^2 +
         mean(unlist(lapply(N_param_list3[[3]], function(matrix) matrix[, 1]))))
}
...
mean.inv.exp.n<-function(x){
  (exp(mean(unlist(lapply(N_param_list4[[1]], function(matrix) matrix[, 1]))))*(x-
         mean(unlist(lapply(N_param_list4[[2]], function(matrix) matrix[, 1]))))^2 +
         mean(unlist(lapply(N_param_list4[[3]], function(matrix) matrix[, 1]))))
}
...
inv.mean.exp.n<-function(x){
  (exp(mean(unlist(lapply(N_param_list5[[1]], function(matrix) matrix[, 1]))))*(x-
         mean(unlist(lapply(N_param_list5[[2]], function(matrix) matrix[, 1]))))^2 +
         mean(unlist(lapply(N_param_list5[[3]], function(matrix) matrix[, 1]))))
}
...
df.n$Method <- factor(c("Individual Exp Data, Exp Model","Mean Exp Data, Exp Model", "Individual Inverse Exp Data, Trunc Norm Model",
               "Mean Inverse Exp Data, Trunc Norm Model", "Inverse Mean Exp Data, Trunc Norm Model", "True Curve"))
df.outliers.n <- df.n |>
  select(Method, x.middle, x.outliers, y.middle, y.outliers) |>
  data.table::data.table()
df.outliers.n <- df.outliers.n[, list(x.outliers = c(unlist(df.outliers.n$x.outliers)), y.outliers = c(unlist(df.outliers.n$y.outliers), rep(NA,215))),
...
ggplot(data=dub.n[1:5,], aes(fill = Method, color = Method)) +
  ...
  theme_classic()+
  #facet_wrap(dub.n$Method[1:5],nrow=2)+
...
double.box.df.wb.n<-data.frame(
  ...
  Method=factor(c(rep("Individual WB Data, Exp Model",938), rep("Mean WB Data, Exp Model", 938), rep("Individual Inverse WB Data, Trunc Norm Model", 938),
               rep("Mean Inverse WB Data, Trunc Norm Model", 938), rep("Inverse Mean WB Data, Trunc Norm Model", 938), rep("Individual WB Data, WB Model", 938),"True Curve"), levels = c("Individual WB Data, Exp Model","Mean WB Data, Exp Model", "Individual Inverse WB Data, Trunc Norm Model",
...
df.wb.n$Method <- factor(c("Individual WB Data, Exp Model","Mean WB Data, Exp Model", "Individual Inverse WB Data, Trunc Norm Model",
               "Mean Inverse WB Data, Trunc Norm Model", "Inverse Mean WB Data, Trunc Norm Model", "Individual WB Data, WB Model",
                "True Curve"))
df.outliers.wb.n <- df.wb.n |>
  select(Method, x.middle, x.outliers, y.middle, y.outliers) |>
  data.table::data.table()
df.outliers.wb.n <- df.outliers.wb.n[, list(x.outliers = unlist(df.outliers.wb.n$x.outliers), y.outliers = c(unlist(df.outliers.wb.n$y.outliers), rep(NA,25))),
                           by = list(Method, x.middle, y.middle)]
...
dub.wb.n$Method <- factor(dub.wb.n$Method, levels = c("Individual WB Data, Exp Model","Mean WB Data, Exp Model", "Individual Inverse WB Data, Trunc Norm Model",
               "Mean Inverse WB Data, Trunc Norm Model", "Inverse Mean WB Data, Trunc Norm Model", "Individual WB Data, WB Model",
                "True Curve"))
...
ggplot(data=dub.wb.n[1:6,], aes(fill = Method, color = Method)) +
  scale_color_manual(values = plasma(7))+
  scale_fill_manual(values = plasma(7))+
  geom_rect(aes(xmin = q1Topt, xmax = q3Topt, ymin = q1Life, ymax = q3Life), alpha = 0.3) +
  geom_rect(aes(xmin = q1Topt, xmax = q3Topt, ymin = q1Life, ymax = q3Life), 
            color = "black", fill = NA) +
...
double.box.df.ex.n$Method <- factor(c(rep("Individual Exp Data, Exp Model",938), rep("Mean Exp Data, Exp Model", 938), rep("Individual Inverse Exp Data, Trunc Norm Model", 938),
               rep("Mean Inverse Exp Data, Trunc Norm Model", 938), rep("Inverse Mean Exp Data, Trunc Norm Model", 938) , "True Curve" 
               )
)
...
dub.ex.n$Method <-factor(dub.ex.n$Method, levels = c("Individual Exp Data, Exp Model","Mean Exp Data, Exp Model", "Individual Inverse Exp Data, Trunc Norm Model",
               "Mean Inverse Exp Data, Trunc Norm Model", "Inverse Mean Exp Data, Trunc Norm Model", "True Curve"))
...
df.ex.n$Method <- factor(c("Individual Exp Data, Exp Model","Mean Exp Data, Exp Model", "Individual Inverse Exp Data, Trunc Norm Model",
               "Mean Inverse Exp Data, Trunc Norm Model", "Inverse Mean Exp Data, Trunc Norm Model", "True Curve"))
df.outliers.ex.n <- df.ex.n |>
  select(Method, x.middle, x.outliers, y.middle, y.outliers) |>
  data.table::data.table()

df.outliers.ex.n <- df.outliers.ex.n[, list(x.outliers = c(unlist(df.outliers.ex.n$x.outliers)), y.outliers = c(unlist(df.outliers.ex.n$y.outliers),rep(NA,101))),
                           by = list(Method, x.middle, y.middle)]
...
ggplot(data=dub.ex.n[1:5,], aes(fill = Method, color = Method)) +
  ...
  theme_classic()+
  facet_wrap(dub.ex.n$Method[1:5],nrow=2)+
...
double.box.df.ex.wb.n$Method <- factor(c(rep("Individual WB Data, Exp Model",938), rep("Mean WB Data, Exp Model", 938), rep("Individual Inverse WB Data, Trunc Norm Model", 938),
...
dub.ex.wb.n$Method <-factor(dub.ex.wb.n$Method, levels = c("Individual WB Data, Exp Model","Mean WB Data, Exp Model", "Individual Inverse WB Data, Trunc Norm Model",
               "Mean Inverse WB Data, Trunc Norm Model", "Inverse Mean WB Data, Trunc Norm Model", "WB Data, WB Model", "True Curve"))
...
df.ex.wb.n$Method <- factor(c("Individual WB Data, Exp Model","Mean WB Data, Exp Model", "Individual Inverse WB Data, Trunc Norm Model",
               "Mean Inverse WB Data, Trunc Norm Model", "Inverse Mean WB Data, Trunc Norm Model", "WB Data, WB Model", "True Curve"))
df.outliers.ex.wb.n <- df.ex.wb.n |>
  select(Method, x.middle, x.outliers, y.middle, y.outliers) |>
  data.table::data.table()

df.outliers.ex.wb.n <- df.outliers.ex.wb.n[, list(x.outliers = c(unlist(df.outliers.ex.wb.n$x.outliers),rep(NA,74)), y.outliers = c(unlist(df.outliers.ex.wb.n$y.outliers))),
                           by = list(Method, x.middle, y.middle)]
...
ggplot(data=dub.ex.wb.n[1:6,], aes(fill = Method, color = Method)) +
  ...
  theme_classic()+
  facet_wrap(dub.ex.wb.n$Method[1:6],nrow=2)+
...
ind.exp.13.n<-qqPlot(N_data.list[[100]]$trait[N_data.list[[100]]$T==13],
       distribution="exp",
       param.list=list(rate=(exp(mean(unlist(lapply(N_param_list1[[1]], function(matrix) matrix[, 1]))))* (13 -
                               mean(unlist(lapply(N_param_list1[[2]], function(matrix) matrix[, 1]))))^2 +
...
ind.exp.17.n<-qqPlot(N_data.list[[100]]$trait[N_data.list[[100]]$T==17],
       distribution="exp",
       param.list=list(rate=(exp(mean(unlist(lapply(N_param_list1[[1]], function(matrix) matrix[, 1]))))* (17 -
                               mean(unlist(lapply(N_param_list1[[2]], function(matrix) matrix[, 1]))))^2 +
                               mean(unlist(lapply(N_param_list1[[3]], function(matrix) matrix[, 1]))))),plot.it=FALSE)
ind.exp.21.n<-qqPlot(data.list[[100]]$trait[data.list[[100]]$T==21],
       distribution="exp",
       param.list=list(rate=(exp(mean(unlist(lapply(N_param_list1[[1]], function(matrix) matrix[, 1]))))* (21 -
                               mean(unlist(lapply(N_param_list1[[2]], function(matrix) matrix[, 1]))))^2 +
                               mean(unlist(lapply(N_param_list1[[3]], function(matrix) matrix[, 1]))))),plot.it=FALSE)
ind.exp.25.n<-qqPlot(N_data.list[[100]]$trait[N_data.list[[100]]$T==25],
       distribution="exp",
       param.list=list(rate=(exp(mean(unlist(lapply(N_param_list1[[1]], function(matrix) matrix[, 1]))))* (25 -
                               mean(unlist(lapply(N_param_list1[[2]], function(matrix) matrix[, 1]))))^2 +
                               mean(unlist(lapply(N_param_list1[[3]], function(matrix) matrix[, 1]))))),plot.it=FALSE)
ind.exp.29.n<-qqPlot(N_data.list[[100]]$trait[N_data.list[[100]]$T==29],
       distribution="exp",
       param.list=list(rate=(exp(mean(unlist(lapply(N_param_list1[[1]], function(matrix) matrix[, 1]))))* (29 -
                               mean(unlist(lapply(N_param_list1[[2]], function(matrix) matrix[, 1]))))^2 +
                               mean(unlist(lapply(N_param_list1[[3]], function(matrix) matrix[, 1]))))),plot.it=FALSE)
...
mean.exp.13.n<-qqPlot(df.mean.mean.exp.n$trait[df.mean.mean.exp.n$T==13],
       distribution="exp",
       param.list=list(rate=(exp(mean(unlist(lapply(N_param_list2[[1]], function(matrix) matrix[, 1]))))* (13 -
                               mean(unlist(lapply(N_param_list2[[2]], function(matrix) matrix[, 1]))))^2 +
...
mean.exp.17.n<-qqPlot(df.mean.mean.exp.n$trait[df.mean.mean.exp.n$T==17],
       distribution="exp",
       param.list=list(rate=(exp(mean(unlist(lapply(N_param_list2[[1]], function(matrix) matrix[, 1]))))* (17 -
                               mean(unlist(lapply(N_param_list2[[2]], function(matrix) matrix[, 1]))))^2 +
                               mean(unlist(lapply(N_param_list2[[3]], function(matrix) matrix[, 1]))))),plot.it=FALSE)
mean.exp.21.n<-qqPlot(df.mean.mean.exp.n$trait[df.mean.mean.exp.n$T==21],
       distribution="exp",
       param.list=list(rate=(exp(mean(unlist(lapply(N_param_list2[[1]], function(matrix) matrix[, 1]))))* (21 -
                               mean(unlist(lapply(N_param_list2[[2]], function(matrix) matrix[, 1]))))^2 +
                               mean(unlist(lapply(N_param_list2[[3]], function(matrix) matrix[, 1]))))),plot.it=FALSE)
mean.exp.25.n<-qqPlot(df.mean.mean.exp.n$trait[df.mean.mean.exp.n$T==25],
       distribution="exp",
       param.list=list(rate=(exp(mean(unlist(lapply(N_param_list2[[1]], function(matrix) matrix[, 1]))))* (25 -
                               mean(unlist(lapply(N_param_list2[[2]], function(matrix) matrix[, 1]))))^2 +
                               mean(unlist(lapply(N_param_list2[[3]], function(matrix) matrix[, 1]))))),plot.it=FALSE)
mean.exp.29.n<-qqPlot(df.mean.mean.exp.n$trait[df.mean.mean.exp.n$T==29],
       distribution="exp",
       param.list=list(rate=(exp(mean(unlist(lapply(N_param_list2[[1]], function(matrix) matrix[, 1]))))* (29 -
                               mean(unlist(lapply(N_param_list2[[2]], function(matrix) matrix[, 1]))))^2 +
                               mean(unlist(lapply(N_param_list2[[3]], function(matrix) matrix[, 1]))))),plot.it=FALSE)


plot(mean.exp.13.n,pch=20,xlim=c(0,40),ylim=c(0,40), col = plasma(5)[1],
...
inv.exp.13.n<-qqPlot(1/N_data.list[[100]]$trait[N_data.list[[100]]$T==13],
       ...
       param.list=list(mean=(exp(mean(unlist(lapply(N_param_list3[[1]], function(matrix) matrix[, 1]))))* (13 -
                               mean(unlist(lapply(N_param_list3[[2]], function(matrix) matrix[, 1]))))^2 +
                               mean(unlist(lapply(N_param_list3[[3]], function(matrix) matrix[, 1])))),
...
inv.exp.17.n<-qqPlot(1/N_data.list[[100]]$trait[N_data.list[[100]]$T==17],
       distribution="normTrunc",
       param.list=list(mean=(exp(mean(unlist(lapply(N_param_list3[[1]], function(matrix) matrix[, 1]))))* (17 -
                               mean(unlist(lapply(N_param_list3[[2]], function(matrix) matrix[, 1]))))^2 +
                               mean(unlist(lapply(N_param_list3[[3]], function(matrix) matrix[, 1])))),
                       sd=1/mean(unlist(lapply(N_param_list3[[5]], function(matrix) matrix[, 1]))),
                       min=0,
...
inv.exp.21.n<-qqPlot(1/N_data.list[[100]]$trait[N_data.list[[100]]$T==21],
       distribution="normTrunc",
       param.list=list(mean=(exp(mean(unlist(lapply(N_param_list3[[1]], function(matrix) matrix[, 1]))))* (21 -
                               mean(unlist(lapply(N_param_list3[[2]], function(matrix) matrix[, 1]))))^2 +
                               mean(unlist(lapply(N_param_list3[[3]], function(matrix) matrix[, 1])))),
                       sd=1/mean(unlist(lapply(N_param_list3[[5]], function(matrix) matrix[, 1]))),
                       min=0,
...
inv.exp.25.n<-qqPlot(1/N_data.list[[100]]$trait[N_data.list[[100]]$T==25],
       distribution="normTrunc",
       param.list=list(mean=(exp(mean(unlist(lapply(N_param_list3[[1]], function(matrix) matrix[, 1]))))* (25 -
                               mean(unlist(lapply(N_param_list3[[2]], function(matrix) matrix[, 1]))))^2 +
                               mean(unlist(lapply(N_param_list3[[3]], function(matrix) matrix[, 1])))),
                       sd=1/mean(unlist(lapply(N_param_list3[[5]], function(matrix) matrix[, 1]))),
                       min=0,
...
inv.exp.29.n<-qqPlot(1/N_data.list[[100]]$trait[N_data.list[[100]]$T==29],
       distribution="normTrunc",
       param.list=list(mean=(exp(mean(unlist(lapply(N_param_list3[[1]], function(matrix) matrix[, 1]))))* (29 -
                               mean(unlist(lapply(N_param_list3[[2]], function(matrix) matrix[, 1]))))^2 +
                               mean(unlist(lapply(N_param_list3[[3]], function(matrix) matrix[, 1])))),
                       sd=1/mean(unlist(lapply(N_param_list3[[5]], function(matrix) matrix[, 1]))),
                       min=0,
...
mean.inv.exp.13.n<-qqPlot(1/df.mean.mean.exp.n$trait[df.mean.mean.exp.n$T==13],
       distribution="normTrunc",
       param.list=list(mean=(exp(mean(unlist(lapply(N_param_list4[[1]], function(matrix) matrix[, 1]))))* (13 -
                               mean(unlist(lapply(N_param_list4[[2]], function(matrix) matrix[, 1]))))^2 +
                               mean(unlist(lapply(N_param_list4[[3]], function(matrix) matrix[, 1])))),
...
mean.inv.exp.17.n<-qqPlot(1/df.mean.mean.exp.n$trait[df.mean.mean.exp.n$T==17],
       distribution="normTrunc",
       param.list=list(mean=(exp(mean(unlist(lapply(N_param_list4[[1]], function(matrix) matrix[, 1]))))* (17 -
                               mean(unlist(lapply(N_param_list4[[2]], function(matrix) matrix[, 1]))))^2 +
                               mean(unlist(lapply(N_param_list4[[3]], function(matrix) matrix[, 1])))),
                       sd=1/mean(unlist(lapply(N_param_list4[[5]], function(matrix) matrix[, 1]))),
                       min=0,
...
mean.inv.exp.21.n<-qqPlot(1/df.mean.mean.exp.n$trait[df.mean.mean.exp.n$T==21],
       distribution="normTrunc",
       param.list=list(mean=(exp(mean(unlist(lapply(N_param_list4[[1]], function(matrix) matrix[, 1]))))* (21 -
                               mean(unlist(lapply(N_param_list4[[2]], function(matrix) matrix[, 1]))))^2 +
                               mean(unlist(lapply(N_param_list4[[3]], function(matrix) matrix[, 1])))),
                       sd=1/mean(unlist(lapply(N_param_list4[[5]], function(matrix) matrix[, 1]))),
                       min=0,
...
mean.inv.exp.25.n<-qqPlot(1/df.mean.mean.exp.n$trait[df.mean.mean.exp.n$T==25],
       distribution="normTrunc",
       param.list=list(mean=(exp(mean(unlist(lapply(N_param_list4[[1]], function(matrix) matrix[, 1]))))* (25 -
                               mean(unlist(lapply(N_param_list4[[2]], function(matrix) matrix[, 1]))))^2 +
                               mean(unlist(lapply(N_param_list4[[3]], function(matrix) matrix[, 1])))),
                       sd=1/mean(unlist(lapply(N_param_list4[[5]], function(matrix) matrix[, 1]))),
                       min=0,
...
mean.inv.exp.29.n<-qqPlot(1/df.mean.mean.exp.n$trait[df.mean.mean.exp.n$T==29],
       distribution="normTrunc",
       param.list=list(mean=(exp(mean(unlist(lapply(N_param_list4[[1]], function(matrix) matrix[, 1]))))* (29 -
                               mean(unlist(lapply(N_param_list4[[2]], function(matrix) matrix[, 1]))))^2 +
                               mean(unlist(lapply(N_param_list4[[3]], function(matrix) matrix[, 1])))),
                       sd=1/mean(unlist(lapply(N_param_list4[[5]], function(matrix) matrix[, 1]))),
                       min=0,
...
inv.mean.exp.13.n<-qqPlot(df.mean.inv.exp.n$trait[df.mean.inv.exp.n$T==13],
       distribution="normTrunc",
       param.list=list(mean=(exp(mean(unlist(lapply(N_param_list5[[1]], function(matrix) matrix[, 1]))))* (13 -
                               mean(unlist(lapply(N_param_list5[[2]], function(matrix) matrix[, 1]))))^2 +
                               mean(unlist(lapply(N_param_list5[[3]], function(matrix) matrix[, 1])))),
...
inv.mean.exp.17.n<-qqPlot(df.mean.inv.exp.n$trait[df.mean.inv.exp.n$T==17],
       distribution="normTrunc",
       param.list=list(mean=(exp(mean(unlist(lapply(N_param_list5[[1]], function(matrix) matrix[, 1]))))* (17 -
                               mean(unlist(lapply(N_param_list5[[2]], function(matrix) matrix[, 1]))))^2 +
                               mean(unlist(lapply(N_param_list5[[3]], function(matrix) matrix[, 1])))),
                       sd=1/mean(unlist(lapply(N_param_list5[[5]], function(matrix) matrix[, 1]))),
                       min=0,
...
inv.mean.exp.21.n<-qqPlot(df.mean.inv.exp.n$trait[df.mean.inv.exp.n$T==21],
       distribution="normTrunc",
       param.list=list(mean=(exp(mean(unlist(lapply(N_param_list5[[1]], function(matrix) matrix[, 1]))))* (21 -
                               mean(unlist(lapply(N_param_list5[[2]], function(matrix) matrix[, 1]))))^2 +
                               mean(unlist(lapply(N_param_list5[[3]], function(matrix) matrix[, 1])))),
                       sd=1/mean(unlist(lapply(N_param_list5[[5]], function(matrix) matrix[, 1]))),
                       min=0,
...
inv.mean.exp.25.n<-qqPlot(df.mean.inv.exp.n$trait[df.mean.inv.exp.n$T==25],
       distribution="normTrunc",
       param.list=list(mean=(exp(mean(unlist(lapply(N_param_list5[[1]], function(matrix) matrix[, 1]))))* (25 -
                               mean(unlist(lapply(N_param_list5[[2]], function(matrix) matrix[, 1]))))^2 +
                               mean(unlist(lapply(N_param_list5[[3]], function(matrix) matrix[, 1])))),
                       sd=1/mean(unlist(lapply(N_param_list5[[5]], function(matrix) matrix[, 1]))),
                       min=0,
...
inv.mean.exp.29.n<-qqPlot(df.mean.inv.exp.n$trait[df.mean.inv.exp.n$T==29],
       distribution="normTrunc",
       param.list=list(mean=(exp(mean(unlist(lapply(N_param_list5[[1]], function(matrix) matrix[, 1]))))* (29 -
                               mean(unlist(lapply(N_param_list5[[2]], function(matrix) matrix[, 1]))))^2 +
                               mean(unlist(lapply(N_param_list5[[3]], function(matrix) matrix[, 1])))),
                       sd=1/mean(unlist(lapply(N_param_list5[[5]], function(matrix) matrix[, 1]))),
                       min=0,
...
plot(inv.mean.exp.13.n,pch=20,xlim=c(0,1),ylim=c(0,10), col = plasma(5)[1],
...
ind.wb.13.n<-qqPlot(Weibull_N_data.list[[100]]$trait[Weibull_N_data.list[[100]]$T==13],
       distribution="exp",
       param.list=list(rate=exp(exp(mean(unlist(lapply(Weibull_N_param_list1[[1]], function(matrix) matrix[, 1]))))* (13 -
...
ind.wb.17.n<-qqPlot(Weibull_N_data.list[[100]]$trait[Weibull_N_data.list[[100]]$T==17],
       distribution="exp",
       param.list=list(rate=exp(exp(mean(unlist(lapply(Weibull_N_param_list1[[1]], function(matrix) matrix[, 1]))))* (17 -
                               (mean(unlist(lapply(Weibull_N_param_list1[[2]], function(matrix) matrix[, 1])))))^2 +
                               mean(unlist(lapply(Weibull_N_param_list1[[3]], function(matrix) matrix[, 1]))))),plot.it=FALSE)
ind.wb.21.n<-qqPlot(Weibull_N_data.list[[100]]$trait[Weibull_N_data.list[[100]]$T==21],
       distribution="exp",
       param.list=list(rate=exp(exp(mean(unlist(lapply(Weibull_N_param_list1[[1]], function(matrix) matrix[, 1]))))* (21 -
                               (mean(unlist(lapply(Weibull_N_param_list1[[2]], function(matrix) matrix[, 1])))))^2 +
                               mean(unlist(lapply(Weibull_N_param_list1[[3]], function(matrix) matrix[, 1]))))),plot.it=FALSE)
ind.wb.25.n<-qqPlot(Weibull_N_data.list[[100]]$trait[Weibull_N_data.list[[100]]$T==25],
       distribution="exp",
       param.list=list(rate=exp(exp(mean(unlist(lapply(Weibull_N_param_list1[[1]], function(matrix) matrix[, 1]))))* (25 -
                               (mean(unlist(lapply(Weibull_N_param_list1[[2]], function(matrix) matrix[, 1])))))^2 +
                               mean(unlist(lapply(Weibull_N_param_list1[[3]], function(matrix) matrix[, 1]))))),plot.it=FALSE)
ind.wb.29.n<-qqPlot(Weibull_N_data.list[[100]]$trait[Weibull_N_data.list[[100]]$T==29],
       distribution="exp",
       param.list=list(rate=exp(exp(mean(unlist(lapply(Weibull_N_param_list1[[1]], function(matrix) matrix[, 1]))))* (29 -
                               (mean(unlist(lapply(Weibull_N_param_list1[[2]], function(matrix) matrix[, 1])))))^2 +
                               mean(unlist(lapply(Weibull_N_param_list1[[3]], function(matrix) matrix[, 1]))))),plot.it=FALSE)

plot(ind.wb.13.n,xlim=c(0,5),ylim=c(0,35),pch=20, col = plasma(5)[1],
...
mean.wb.13.n<-qqPlot(df.mean.mean.wb.n$trait[df.mean.mean.wb.n$T==13],
       distribution="exp",
       param.list=list(rate=exp(exp(mean(unlist(lapply(Weibull_N_param_list2[[1]], function(matrix) matrix[, 1]))))* (13 -
...
mean.wb.17.n<-qqPlot(df.mean.mean.wb.n$trait[df.mean.mean.wb.n$T==17],
       distribution="exp",
       param.list=list(rate=exp(exp(mean(unlist(lapply(Weibull_N_param_list2[[1]], function(matrix) matrix[, 1]))))* (17 -
                               (mean(unlist(lapply(Weibull_N_param_list2[[2]], function(matrix) matrix[, 1])))))^2 +
                               mean(unlist(lapply(Weibull_N_param_list2[[3]], function(matrix) matrix[, 1]))))),plot.it=FALSE)
mean.wb.21.n<-qqPlot(df.mean.mean.wb.n$trait[df.mean.mean.wb.n$T==21],
       distribution="exp",
       param.list=list(rate=exp(exp(mean(unlist(lapply(Weibull_N_param_list2[[1]], function(matrix) matrix[, 1]))))* (21 -
                               (mean(unlist(lapply(Weibull_N_param_list2[[2]], function(matrix) matrix[, 1])))))^2 +
                               mean(unlist(lapply(Weibull_N_param_list2[[3]], function(matrix) matrix[, 1]))))),plot.it=FALSE)
mean.wb.25.n<-qqPlot(df.mean.mean.wb.n$trait[df.mean.mean.wb.n$T==25],
       distribution="exp",
       param.list=list(rate=exp(exp(mean(unlist(lapply(Weibull_N_param_list2[[1]], function(matrix) matrix[, 1]))))* (25 -
                               (mean(unlist(lapply(Weibull_N_param_list2[[2]], function(matrix) matrix[, 1])))))^2 +
                               mean(unlist(lapply(Weibull_N_param_list2[[3]], function(matrix) matrix[, 1]))))),plot.it=FALSE)
mean.wb.29.n<-qqPlot(df.mean.mean.wb.n$trait[df.mean.mean.wb.n$T==29],
       distribution="exp",
       param.list=list(rate=exp(exp(mean(unlist(lapply(Weibull_N_param_list2[[1]], function(matrix) matrix[, 1]))))* (29 -
                               (mean(unlist(lapply(Weibull_N_param_list2[[2]], function(matrix) matrix[, 1])))))^2 +
                               mean(unlist(lapply(Weibull_N_param_list2[[3]], function(matrix) matrix[, 1]))))),plot.it=FALSE)


plot(mean.wb.13.n,pch=20,xlim=c(0,3),ylim=c(0,30), col = plasma(5)[1],
...
inv.wb.13.n<-qqPlot(1/Weibull_N_data.list[[100]]$trait[Weibull_N_data.list[[100]]$T==13],
       distribution="normTrunc",
       param.list=list(mean=exp(exp(mean(unlist(lapply(Weibull_N_param_list3[[1]], function(matrix) matrix[, 1]))))*(13 -
...
inv.wb.17.n<-qqPlot(1/Weibull_N_data.list[[100]]$trait[Weibull_N_data.list[[100]]$T==17],
       distribution="normTrunc",
       param.list=list(mean=exp(exp(mean(unlist(lapply(Weibull_N_param_list3[[1]], function(matrix) matrix[, 1]))))*(17 -
                               (mean(unlist(lapply(Weibull_N_param_list3[[2]], function(matrix) matrix[, 1])))))^2 +
                               mean(unlist(lapply(Weibull_N_param_list3[[3]], function(matrix) matrix[, 1])))),
                       sd=1/mean(unlist(lapply(Weibull_N_param_list3[[5]], function(matrix) matrix[, 1]))),
                       min=0,
...
inv.wb.21.n<-qqPlot(1/Weibull_N_data.list[[100]]$trait[Weibull_N_data.list[[100]]$T==21],
       distribution="normTrunc",
       param.list=list(mean=exp(exp(mean(unlist(lapply(Weibull_N_param_list3[[1]], function(matrix) matrix[, 1]))))*(21 -
                               (mean(unlist(lapply(Weibull_N_param_list3[[2]], function(matrix) matrix[, 1])))))^2 +
                               mean(unlist(lapply(Weibull_N_param_list3[[3]], function(matrix) matrix[, 1])))),
                       sd=1/mean(unlist(lapply(Weibull_N_param_list3[[5]], function(matrix) matrix[, 1]))),
                       min=0,
...
inv.wb.25.n<-qqPlot(1/Weibull_N_data.list[[100]]$trait[Weibull_N_data.list[[100]]$T==25],
       distribution="normTrunc",
       param.list=list(mean=exp(exp(mean(unlist(lapply(Weibull_N_param_list3[[1]], function(matrix) matrix[, 1]))))*(25 -
                               (mean(unlist(lapply(Weibull_N_param_list3[[2]], function(matrix) matrix[, 1])))))^2 +
                               mean(unlist(lapply(Weibull_N_param_list3[[3]], function(matrix) matrix[, 1])))),
                       sd=1/mean(unlist(lapply(Weibull_N_param_list3[[5]], function(matrix) matrix[, 1]))),
                       min=0,
...
inv.wb.29.n<-qqPlot(1/Weibull_N_data.list[[100]]$trait[Weibull_N_data.list[[100]]$T==29],
       distribution="normTrunc",
       param.list=list(mean=exp(exp(mean(unlist(lapply(Weibull_N_param_list3[[1]], function(matrix) matrix[, 1]))))*(29 -
                               (mean(unlist(lapply(Weibull_N_param_list3[[2]], function(matrix) matrix[, 1])))))^2 +
                               mean(unlist(lapply(Weibull_N_param_list3[[3]], function(matrix) matrix[, 1])))),
                       sd=1/mean(unlist(lapply(Weibull_N_param_list3[[5]], function(matrix) matrix[, 1]))),
                       min=0,
...
mean.inv.wb.13.n<-qqPlot(df.mean.mean.wb.n$trait[df.mean.mean.wb.n$T==13],
       distribution="normTrunc",
       param.list=list(mean=exp(exp(mean(unlist(lapply(Weibull_N_param_list4[[1]], function(matrix) matrix[, 1]))))*(13 -
...
mean.inv.wb.17.n<-qqPlot(df.mean.mean.wb.n$trait[df.mean.mean.wb.n$T==17],
       distribution="normTrunc",
       param.list=list(mean=exp(exp(mean(unlist(lapply(Weibull_N_param_list4[[1]], function(matrix) matrix[, 1]))))*(17 -
                               (mean(unlist(lapply(Weibull_N_param_list4[[2]], function(matrix) matrix[, 1])))))^2 +
                               mean(unlist(lapply(Weibull_N_param_list4[[3]], function(matrix) matrix[, 1])))),
                       sd=1/mean(unlist(lapply(Weibull_N_param_list4[[5]], function(matrix) matrix[, 1]))),
                       min=0,
...
mean.inv.wb.21.n<-qqPlot(df.mean.mean.wb.n$trait[df.mean.mean.wb.n$T==21],
       distribution="normTrunc",
       param.list=list(mean=exp(exp(mean(unlist(lapply(Weibull_N_param_list4[[1]], function(matrix) matrix[, 1]))))*(21 -
                               (mean(unlist(lapply(Weibull_N_param_list4[[2]], function(matrix) matrix[, 1])))))^2 +
                               mean(unlist(lapply(Weibull_N_param_list4[[3]], function(matrix) matrix[, 1])))),
                       sd=1/mean(unlist(lapply(Weibull_N_param_list4[[5]], function(matrix) matrix[, 1]))),
                       min=0,
...
mean.inv.wb.25.n<-qqPlot(df.mean.mean.wb.n$trait[df.mean.mean.wb.n$T==25],
       distribution="normTrunc",
       param.list=list(mean=exp(exp(mean(unlist(lapply(Weibull_N_param_list4[[1]], function(matrix) matrix[, 1]))))*(25 -
                               (mean(unlist(lapply(Weibull_N_param_list4[[2]], function(matrix) matrix[, 1])))))^2 +
                               mean(unlist(lapply(Weibull_N_param_list4[[3]], function(matrix) matrix[, 1])))),
                       sd=1/mean(unlist(lapply(Weibull_N_param_list4[[5]], function(matrix) matrix[, 1]))),
                       min=0,
...
mean.inv.wb.29.n<-qqPlot(df.mean.mean.wb.n$trait[df.mean.mean.wb.n$T==29],
       distribution="normTrunc",
       param.list=list(mean=exp(exp(mean(unlist(lapply(Weibull_N_param_list4[[1]], function(matrix) matrix[, 1]))))*(29 -
                               (mean(unlist(lapply(Weibull_N_param_list4[[2]], function(matrix) matrix[, 1])))))^2 +
                               mean(unlist(lapply(Weibull_N_param_list4[[3]], function(matrix) matrix[, 1])))),
                       sd=1/mean(unlist(lapply(Weibull_N_param_list4[[5]], function(matrix) matrix[, 1]))),
                       min=0,
...
inv.mean.wb.13.n<-qqPlot(df.mean.inv.wb.n$trait[df.mean.inv.wb.n$T==13],
       distribution="normTrunc",
       param.list=list(mean=exp(exp(mean(unlist(lapply(Weibull_N_param_list5[[1]], function(matrix) matrix[, 1]))))*(13 -
...
inv.mean.wb.17.n<-qqPlot(df.mean.inv.wb.n$trait[df.mean.inv.wb.n$T==17],
       distribution="normTrunc",
       param.list=list(mean=exp(exp(mean(unlist(lapply(Weibull_N_param_list5[[1]], function(matrix) matrix[, 1]))))*(17 -
                               (mean(unlist(lapply(Weibull_N_param_list5[[2]], function(matrix) matrix[, 1])))))^2 +
                               mean(unlist(lapply(Weibull_N_param_list5[[3]], function(matrix) matrix[, 1])))),
                       sd=1/mean(unlist(lapply(Weibull_N_param_list5[[5]], function(matrix) matrix[, 1]))),
                       min=0,
...
inv.mean.wb.21.n<-qqPlot(df.mean.inv.wb.n$trait[df.mean.inv.wb.n$T==21],
       distribution="normTrunc",
       param.list=list(mean=exp(exp(mean(unlist(lapply(Weibull_N_param_list5[[1]], function(matrix) matrix[, 1]))))*(21 -
                               (mean(unlist(lapply(Weibull_N_param_list5[[2]], function(matrix) matrix[, 1])))))^2 +
                               mean(unlist(lapply(Weibull_N_param_list5[[3]], function(matrix) matrix[, 1])))),
                       sd=1/mean(unlist(lapply(Weibull_N_param_list5[[5]], function(matrix) matrix[, 1]))),
                       min=0,
...
inv.mean.wb.25.n<-qqPlot(df.mean.inv.wb.n$trait[df.mean.inv.wb.n$T==25],
       distribution="normTrunc",
       param.list=list(mean=exp(exp(mean(unlist(lapply(Weibull_N_param_list5[[1]], function(matrix) matrix[, 1]))))*(25 -
                               (mean(unlist(lapply(Weibull_N_param_list5[[2]], function(matrix) matrix[, 1])))))^2 +
                               mean(unlist(lapply(Weibull_N_param_list5[[3]], function(matrix) matrix[, 1])))),
                       sd=1/mean(unlist(lapply(Weibull_N_param_list5[[5]], function(matrix) matrix[, 1]))),
                       min=0,
...
inv.mean.wb.29.n<-qqPlot(df.mean.inv.wb.n$trait[df.mean.inv.wb.n$T==29],
       distribution="normTrunc",
       param.list=list(mean=exp(exp(mean(unlist(lapply(Weibull_N_param_list5[[1]], function(matrix) matrix[, 1]))))*(29 -
                               (mean(unlist(lapply(Weibull_N_param_list5[[2]], function(matrix) matrix[, 1])))))^2 +
                               mean(unlist(lapply(Weibull_N_param_list5[[3]], function(matrix) matrix[, 1])))),
                       sd=1/mean(unlist(lapply(Weibull_N_param_list5[[5]], function(matrix) matrix[, 1]))),
                       min=0,
...
xdf1_N$true.value<-rep(f(seq(from= 5, to = 37, length.out = 250)),938)
xdf2_N$true.value<-rep(f(seq(from= 5, to = 37, length.out = 250)),938)
xdf3_N$true.value<-rep(f(seq(from= 5, to = 37, length.out = 250)),938)
xdf4_N$true.value<-rep(f(seq(from= 5, to = 37, length.out = 250)),938)
xdf5_N$true.value<-rep(f(seq(from= 5, to = 37, length.out = 250)),938)


rmse1_N<-xdf1_N |> group_by(point) |> summarize(rmse1=sqrt(mean((trunc.inv-1/true.value)^2))) |> select(rmse1)
rmse2_N<-xdf2_N |> group_by(point) |> summarize(rmse2=sqrt(mean((trunc.inv-1/true.value)^2)))|> select(rmse2)
rmse3_N<-xdf3_N |> group_by(point) |> summarize(rmse3=sqrt(mean((trunc.inv-1/true.value)^2)))|> select(rmse3)
rmse4_N<-xdf4_N |> group_by(point) |> summarize(rmse4=sqrt(mean((trunc.inv-1/true.value)^2)))|> select(rmse4)
rmse5_N<-xdf5_N |> group_by(point) |> summarize(rmse5=sqrt(mean((trunc.inv-1/true.value)^2)))|> select(rmse5)


boxplot.df_N<-data.frame(
  Method=factor(c(rep("Individual Exp Data, Exp Model",250),rep("Mean Exp Data, Exp Model",250),rep("Individual Inverse Exp Data, Trunc Norm Model",250),rep("Mean Inverse Exp Data, Trunc Norm Model",250),rep("Inverse Mean Exp Data, Trunc Norm Model",250)),levels=c("Individual Exp Data, Exp Model","Mean Exp Data, Exp Model","Individual Inverse Exp Data, Trunc Norm Model","Mean Inverse Exp Data, Trunc Norm Model","Inverse Mean Exp Data, Trunc Norm Model")),
  ...
  Temperature=c(rep(seq(from=5,to=37,length.out=250),5))
)
...
xdf1_W_N$true.value<-rep(my.med(seq(from= 5, to = 37, length.out = 250)),938)
xdf2_W_N$true.value<-rep(my.med(seq(from= 5, to = 37, length.out = 250)),938)
xdf3_W_N$true.value<-rep(my.med(seq(from= 5, to = 37, length.out = 250)),938)
xdf4_W_N$true.value<-rep(my.med(seq(from= 5, to = 37, length.out = 250)),938)
xdf5_W_N$true.value<-rep(my.med(seq(from= 5, to = 37, length.out = 250)),938)
xdf6_W_N$true.value<-rep(my.med(seq(from= 5, to = 37, length.out = 250)),938)


rmse1.wb_N<-xdf1_W_N |> group_by(point) |> summarize(rmse1.wb=sqrt(mean((trunc.eval-true.value)^2))) |> select(rmse1.wb)
rmse2.wb_N<-xdf2_W_N |> group_by(point) |> summarize(rmse2.wb=sqrt(mean((trunc.eval-true.value)^2)))|> select(rmse2.wb)
rmse3.wb_N<-xdf3_W_N |> group_by(point) |> summarize(rmse3.wb=sqrt(mean((trunc.eval-true.value)^2)))|> select(rmse3.wb)
rmse4.wb_N<-xdf4_W_N |> group_by(point) |> summarize(rmse4.wb=sqrt(mean((trunc.eval-true.value)^2)))|> select(rmse4.wb)
rmse5.wb_N<-xdf5_W_N |> group_by(point) |> summarize(rmse5.wb=sqrt(mean((trunc.eval-true.value)^2)))|> select(rmse5.wb)
rmse6.wb_N<-xdf6_W_N |> group_by(point) |> summarize(rmse6.wb=sqrt(mean((trunc.eval-true.value)^2)))|> select(rmse6.wb)


boxplot.df.wb_N<-data.frame(
  Method=factor(c(rep("Individual WB Data, Exp Model",250),rep("Mean WB Data, Exp Model",250),rep("Individual Inverse WB Data, Trunc Norm Model",250),rep("Mean Inverse WB Data, Trunc Norm Model",250),rep("Inverse Mean WB Data, Trunc Norm Model",250),rep("WB Data, WB Model",250)),levels=rev(c("WB Data, WB Model","Inverse Mean WB Data, Trunc Norm Model","Mean Inverse WB Data, Trunc Norm Model","Individual Inverse WB Data, Trunc Norm Model",
...
joint.box_N <- rbind(boxplot.df_N,boxplot.df.wb_N)
joint.box_N$Method <- factor(joint.box_N$Method, levels = rev(desired_order.compare))
...
RMSE.tab.exp_N <- do.call(rbind, summary_list_N)

RMSE.tab.exp_N$Method <- factor(c(
...
RMSE.tab.exp_N |> ggplot(aes(x=Method, y=RMSE))+
  ...
  scale_x_discrete(limits = rev(levels(RMSE.tab.exp_N$Method)))+
  labs(title="RMSE Boxplot, Narrow Interval",
       subtitle = "Exponential Data")+
  coord_flip()+
  theme_classic()
```

```{r RMSE.Table.WB.Narrow}
summary_list.wb_N <- list(
  xdf1_W_N |> summarize(RMSE = sqrt(mean((trunc.eval - true.value)^2))),
  xdf2_W_N |> summarize(RMSE = sqrt(mean((trunc.eval - true.value)^2))),
  xdf3_W_N |> summarize(RMSE = sqrt(mean((trunc.eval - true.value)^2))),
  xdf4_W_N |> summarize(RMSE = sqrt(mean((trunc.eval - true.value)^2))),
  xdf5_W_N |> summarize(RMSE = sqrt(mean((trunc.eval - true.value)^2))),
  xdf6_W_N |> summarize(RMSE = sqrt(mean((trunc.eval - true.value)^2)))
)

# Convert the list into a matrix
RMSE.tab.wb_N <- do.call(rbind, summary_list.wb_N)

RMSE.tab.wb_N$Method <- factor(c(
...
RMSE.tab.wb_N |> ggplot(aes(x=Method, y=RMSE))+
  geom_bar(stat = "identity", position = "dodge", color = "black", fill = mako(10)[5])+
  geom_text(aes(label = round(RMSE, 4)), hjust = -0.2, position = position_dodge(width = 0.9)) +
  scale_x_discrete(limits = rev(levels(RMSE.tab.wb_N$Method)))+
  labs(title="RMSE Boxplot, Narrow Interval",
...
summary_list.compare_N <- list(
  xdf1_N |> summarize(RMSE = sqrt(mean((trunc.inv - true.value)^2))),
  xdf1_W_N |> summarize(RMSE = sqrt(mean((trunc.eval - true.value)^2))),
  xdf6_W_N |> summarize(RMSE = sqrt(mean((trunc.eval - true.value)^2))),
  xdf2_N |> summarize(RMSE = sqrt(mean((trunc.inv - true.value)^2))),
  xdf2_W_N |> summarize(RMSE = sqrt(mean((trunc.eval - true.value)^2))),
  xdf3_N |> summarize(RMSE = sqrt(mean((trunc.inv - true.value)^2))),
  xdf3_W_N |> summarize(RMSE = sqrt(mean((trunc.eval - true.value)^2))),
  xdf4_N |> summarize(RMSE = sqrt(mean((trunc.inv - true.value)^2))),
  xdf4_W_N |> summarize(RMSE = sqrt(mean((trunc.eval - true.value)^2))),
  xdf5_N |> summarize(RMSE = sqrt(mean((trunc.inv - true.value)^2))),
  xdf5_W_N |> summarize(RMSE = sqrt(mean((trunc.eval - true.value)^2)))
)
...
N_data.rmse.ind.exp <- function(temp, values, a, Topt, c) {
  curve_value <- 1/(exp(mean(unlist(lapply(N_param_list1[[1]], function(matrix) matrix[, 1])))) * (temp - 
    mean(unlist(lapply(N_param_list1[[2]], function(matrix) matrix[, 1]))))^2 + 
    mean(unlist(lapply(N_param_list1[[3]], function(matrix) matrix[, 1]))))
...
N_data.rmse.mean.exp <- function(temp, values, a, Topt, c) {
  curve_value <- 1/(exp(mean(unlist(lapply(N_param_list2[[1]], function(matrix) matrix[, 1])))) * (temp - 
    mean(unlist(lapply(N_param_list2[[2]], function(matrix) matrix[, 1]))))^2 + 
    mean(unlist(lapply(N_param_list2[[3]], function(matrix) matrix[, 1]))))
  sqrt(mean((values - curve_value)^2))
}
...
N_data.rmse.inv.exp <- function(temp, values, a, Topt, c) {
  curve_value <- 1/(exp(mean(unlist(lapply(N_param_list3[[1]], function(matrix) matrix[, 1])))) * (temp - 
    mean(unlist(lapply(N_param_list3[[2]], function(matrix) matrix[, 1]))))^2 + 
    mean(unlist(lapply(N_param_list3[[3]], function(matrix) matrix[, 1]))))
  sqrt(mean((values - curve_value)^2))
}
...
N_data.rmse.mean.inv.exp <- function(temp, values, a, Topt, c) {
  curve_value <- 1/(exp(mean(unlist(lapply(N_param_list4[[1]], function(matrix) matrix[, 1])))) * (temp - 
    mean(unlist(lapply(N_param_list4[[2]], function(matrix) matrix[, 1]))))^2 + 
    mean(unlist(lapply(N_param_list4[[3]], function(matrix) matrix[, 1]))))
  sqrt(mean((values - curve_value)^2))
}
...
N_data.rmse.inv.mean.exp <- function(temp, values, a, Topt, c) {
  curve_value <- 1/(exp(mean(unlist(lapply(N_param_list5[[1]], function(matrix) matrix[, 1])))) * (temp - 
    mean(unlist(lapply(N_param_list5[[2]], function(matrix) matrix[, 1]))))^2 + 
    mean(unlist(lapply(N_param_list5[[3]], function(matrix) matrix[, 1]))))
  sqrt(mean((values - curve_value)^2))
}
...
N_data.rmse.ind.wb <- function(temp, values, a, b, c) {
  curve_value <- exp(-(exp(mean(unlist(lapply(Weibull_N_param_list1[[1]], function(matrix) matrix[, 1])))) * temp^2 - 
    mean(unlist(lapply(Weibull_N_param_list1[[2]], function(matrix) matrix[, 1])))* temp + 
    mean(unlist(lapply(Weibull_N_param_list1[[3]], function(matrix) matrix[, 1])))))
  sqrt(mean((values - curve_value)^2))
}
# Group data by temperature and calculate RMSE for each group
N_rmse.ind.wb <- bind_rows(Weibull_N_data.list) %>%
  group_by(T) %>%
  summarise(
    rmse = N_data.rmse.ind.wb(unique(T), trait, a, b, c)) |> 
    summarise(
    RMSE = sqrt(mean(rmse^2))
  )

N_data.rmse.mean.wb <- function(temp, values, a, b, c) {
  curve_value <- exp(-(exp(mean(unlist(lapply(Weibull_N_param_list2[[1]], function(matrix) matrix[, 1])))) * temp^2 - 
    mean(unlist(lapply(Weibull_N_param_list2[[2]], function(matrix) matrix[, 1])))* temp + 
    mean(unlist(lapply(Weibull_N_param_list2[[3]], function(matrix) matrix[, 1])))))
  sqrt(mean((values - curve_value)^2))
}
# Group data by temperature and calculate RMSE for each group
N_rmse.mean.wb <- bind_rows(Weibull_N_data.list) %>%
  group_by(T) %>%
  summarise(
    rmse = N_data.rmse.mean.wb(unique(T), trait, a, b, c)) |> 
    summarise(
    RMSE = sqrt(mean(rmse^2))
  )

N_data.rmse.inv.wb <- function(temp, values, a, b, c) {
  curve_value <- exp(-(exp(mean(unlist(lapply(Weibull_N_param_list3[[1]], function(matrix) matrix[, 1])))) * temp^2 - 
    mean(unlist(lapply(Weibull_N_param_list3[[2]], function(matrix) matrix[, 1])))* temp + 
    mean(unlist(lapply(Weibull_N_param_list3[[3]], function(matrix) matrix[, 1])))))
  sqrt(mean((values - curve_value)^2))
}
# Group data by temperature and calculate RMSE for each group
N_rmse.inv.wb <- bind_rows(Weibull_N_data.list) %>%
  group_by(T) %>%
  summarise(
    rmse = N_data.rmse.inv.wb(unique(T), trait, a, b, c)) |> 
    summarise(
    RMSE = sqrt(mean(rmse^2))
  )

N_data.rmse.mean.inv.wb <- function(temp, values, a, b, c) {
  curve_value <- exp(-(exp(mean(unlist(lapply(Weibull_N_param_list4[[1]], function(matrix) matrix[, 1])))) * temp^2 - 
    mean(unlist(lapply(Weibull_N_param_list4[[2]], function(matrix) matrix[, 1])))* temp + 
    mean(unlist(lapply(Weibull_N_param_list4[[3]], function(matrix) matrix[, 1])))))
  sqrt(mean((values - curve_value)^2))
}
# Group data by temperature and calculate RMSE for each group
N_rmse.mean.inv.wb <- bind_rows(Weibull_N_data.list) %>%
  group_by(T) %>%
  summarise(
    rmse = N_data.rmse.mean.inv.wb(unique(T), trait, a, b, c)) |> 
    summarise(
    RMSE = sqrt(mean(rmse^2))
  )

N_data.rmse.inv.mean.wb <- function(temp, values, a, b, c) {
  curve_value <- exp(-(exp(mean(unlist(lapply(Weibull_N_param_list5[[1]], function(matrix) matrix[, 1])))) * temp^2 - 
    mean(unlist(lapply(Weibull_N_param_list5[[2]], function(matrix) matrix[, 1])))* temp + 
    mean(unlist(lapply(Weibull_N_param_list5[[3]], function(matrix) matrix[, 1])))))
  sqrt(mean((values - curve_value)^2))
}
# Group data by temperature and calculate RMSE for each group
N_rmse.inv.mean.wb <- bind_rows(Weibull_N_data.list) %>%
  group_by(T) %>%
  summarise(
    rmse = N_data.rmse.inv.mean.wb(unique(T), trait, a, b, c)) |> 
    summarise(
    RMSE = sqrt(mean(rmse^2))
  )

N_data.rmse.wb.wb <- function(temp, values, a, b, c) {
  curve_value <- exp(-(exp(mean(unlist(lapply(Weibull_N_param_list6[[1]], function(matrix) matrix[, 1])))) * temp^2 - 
    mean(unlist(lapply(Weibull_N_param_list6[[2]], function(matrix) matrix[, 1])))* temp + 
    mean(unlist(lapply(Weibull_N_param_list6[[3]], function(matrix) matrix[, 1])))))
  sqrt(mean((values - curve_value)^2))
}
# Group data by temperature and calculate RMSE for each group
N_rmse.wb.wb <- bind_rows(Weibull_N_data.list) %>%
  group_by(T) %>%
  summarise(
    rmse = N_data.rmse.wb.wb(unique(T), trait, a, b, c)) |> 
    summarise(
    RMSE = sqrt(mean(rmse^2))
  )
