...
topt.mean.exp.n<-data.frame(
  ...
  Method=factor(c("Individual Exp Data, Exp Model","Mean Exp Data, Exp Model","Individual Inverse Exp Data, Exp Model",
               "Mean Inverse Exp Data, Exp Model","Inverse Mean Exp Data, Exp Model","True Curve"),levels=c("Individual Exp Data, Exp Model","Mean Exp Data, Exp Model","Individual Inverse Exp Data, Exp Model",
               "Mean Inverse Exp Data, Exp Model","Inverse Mean Exp Data, Exp Model", "True Curve"))
)
...
double.box.df.n<-data.frame(
  ...
  Method=factor(c(rep("Individual Exp Data, Exp Model",938), rep("Mean Exp Data, Exp Model", 938), rep("Individual Inverse Exp Data, Exp Model", 938),
               rep("Mean Inverse Exp Data, Exp Model", 938), rep("Inverse Mean Exp Data, Exp Model", 938), "True Curve")
               )
)
...
#df.outliers.n <- df.outliers.n[, list(x.outliers = c(unlist(df.outliers.n$x.outliers)), y.outliers = c(unlist(df.outliers.n$y.outliers), rep(NA, 154))),
...
#df.outliers.ex.n <- df.outliers.ex.n[, list(x.outliers = c(unlist(df.outliers.ex.n$x.outliers)), y.outliers = c(unlist(df.outliers.ex.n$y.outliers),rep(NA,53))),
    #                       by = list(Method, x.middle, y.middle)]
...
plot(inv.wb.13.n,xlim=c(0,500),ylim=c(0,0.4),pch=20, col = plasma(5)[1],
...
plot(mean.inv.wb.13.n,pch=20,ylim=c(0,30),xlim=c(0,15000), col = plasma(5)[1],
...
plot(inv.mean.wb.13.n,pch=20,xlim=c(0,4000),ylim=c(0,0.3), col = plasma(5)[1],
...
boxplot.df_N<-data.frame(
  Method=factor(c(rep("Individual Exp Data, Exp Model",250),rep("Mean Exp Data, Exp Model",250),rep("Individual Inverse Exp Data, Exp Model",250),rep("Mean Inverse Exp Data, Exp Model",250),rep("Inverse Mean Exp Data, Exp Model",250)),levels=c("Individual Exp Data, Exp Model","Mean Exp Data, Exp Model","Individual Inverse Exp Data, Exp Model","Mean Inverse Exp Data, Exp Model","Inverse Mean Exp Data, Exp Model")),
