...
N_b.plot <- ggplot(N_df.b, aes(x, Mean))+
  ...
  geom_hline(yintercept = true.b, linetype = "dashed", color = cividis(3)[3])+
  theme_classic()+
  coord_flip()
N_b.plot
```
...
log_N_b.plot <- ggplot(log_N_df.b, aes(x, log(Mean)))+
  ...
  geom_hline(yintercept = log(true.b), linetype = "dashed", color = cividis(3)[3])+
  theme_classic()+
  coord_flip()
log_N_b.plot
```
...
xseq.n <- seq(from = 5, to = 37, length.out = 250)
...
ggplot(data=dub.n[1:5,], aes(fill = Method, color = Method)) +
  ...
  theme_classic()+
  facet_wrap(dub.n$Method[1:5],nrow=2, scales = "free_y")+
...
ggplot(data=dub.ex.n[1:5,], aes(fill = Method, color = Method)) +
  ...
  theme_classic()+
  #facet_wrap(dub.ex.n$Method[1:5],nrow=2, scales = "free_y")+
...
plot(mean.exp.13.n,pch=20,xlim=c(0,20),ylim=c(0,40), col = plasma(5)[1],
...
plot(inv.mean.exp.13.n,pch=20,xlim=c(0,6.5),ylim=c(0,10), col = plasma(5)[1],
...
plot(ind.wb.13.n,xlim=c(0,90),ylim=c(0,35),pch=20, col = plasma(5)[1],
...
plot(mean.wb.13.n,pch=20,xlim=c(0,60),ylim=c(0,30), col = plasma(5)[1],
...
plot(inv.wb.13.n,xlim=c(0,80),ylim=c(0,0.5),pch=20, col = plasma(5)[1],
...
plot(mean.inv.wb.13.n,pch=20,ylim=c(0,30),xlim=c(0,200), col = plasma(5)[1],
...
xdf1_N$true.value<-rep(true_curve(seq(from= 5, to = 37, length.out = 250)),938)
xdf2_N$true.value<-rep(true_curve(seq(from= 5, to = 37, length.out = 250)),938)
xdf3_N$true.value<-rep(true_curve(seq(from= 5, to = 37, length.out = 250)),938)
xdf4_N$true.value<-rep(true_curve(seq(from= 5, to = 37, length.out = 250)),938)
xdf5_N$true.value<-rep(true_curve(seq(from= 5, to = 37, length.out = 250)),938)
