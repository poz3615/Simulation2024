...
c.wb.plot.n <- ggplot(df.c.wb.n, aes(x, Mean))+
  ...
  geom_hline(yintercept = true.c, linetype = "dashed", color = plasma(3)[3])+
  theme_classic()+
  coord_flip()
c.wb.plot.n
```
...
for (df_index.wb.n in 1:length(df_list.wb.n)) {
  ...
  if (df_index.wb.n == 1 || df_index.wb.n == 2) {
    a_col <- 3
    Topt_col <- 4
    c_col <- 1
  } else {
...
wb.wb.13.n<-qqPlot(Weibull_N_data.list[[100]]$trait[Weibull_N_data.list[[100]]$T==13],
       ...
       param.list=list(scale=1/(exp(mean(unlist(lapply(Weibull_N_param_list6[[1]], function(matrix) matrix[, 1]))))*(13 -
                               (mean(unlist(lapply(Weibull_N_param_list6[[2]], function(matrix) matrix[, 1])))))^2 +
...
wb.wb.17.n<-qqPlot(Weibull_N_data.list[[100]]$trait[Weibull_N_data.list[[100]]$T==17],
       distribution="weibull",
       param.list=list(scale=1/(exp(mean(unlist(lapply(Weibull_N_param_list6[[1]], function(matrix) matrix[, 1]))))*(17 -
                               (mean(unlist(lapply(Weibull_N_param_list6[[2]], function(matrix) matrix[, 1])))))^2 +
                               mean(unlist(lapply(Weibull_N_param_list6[[3]], function(matrix) matrix[, 1]))))/log(2)^(1/mean(unlist(lapply(Weibull_N_param_list6[[5]], function(matrix) matrix[, 1])))),shape=mean(unlist(lapply(Weibull_N_param_list6[[5]], function(matrix) matrix[, 1])))),plot.it=FALSE)

wb.wb.21.n<-qqPlot(Weibull_N_data.list[[100]]$trait[Weibull_N_data.list[[100]]$T==21],
       distribution="weibull",
       param.list=list(scale=1/(exp(mean(unlist(lapply(Weibull_N_param_list6[[1]], function(matrix) matrix[, 1]))))*(21 -
                               (mean(unlist(lapply(Weibull_N_param_list6[[2]], function(matrix) matrix[, 1])))))^2 +
                               mean(unlist(lapply(Weibull_N_param_list6[[3]], function(matrix) matrix[, 1]))))/log(2)^(1/mean(unlist(lapply(Weibull_N_param_list6[[5]], function(matrix) matrix[, 1])))),shape=mean(unlist(lapply(Weibull_N_param_list6[[5]], function(matrix) matrix[, 1])))),plot.it=FALSE)

wb.wb.25.n<-qqPlot(Weibull_N_data.list[[100]]$trait[Weibull_N_data.list[[100]]$T==25],
       distribution="weibull",
       param.list=list(scale=1/(exp(mean(unlist(lapply(Weibull_N_param_list6[[1]], function(matrix) matrix[, 1]))))*(25 -
                               (mean(unlist(lapply(Weibull_N_param_list6[[2]], function(matrix) matrix[, 1])))))^2 +
                               mean(unlist(lapply(Weibull_N_param_list6[[3]], function(matrix) matrix[, 1]))))/log(2)^(1/mean(unlist(lapply(Weibull_N_param_list6[[5]], function(matrix) matrix[, 1])))),shape=mean(unlist(lapply(Weibull_N_param_list6[[5]], function(matrix) matrix[, 1])))),plot.it=FALSE)

wb.wb.29.n<-qqPlot(Weibull_N_data.list[[100]]$trait[Weibull_N_data.list[[100]]$T==29],
       distribution="weibull",
       param.list=list(scale=1/(exp(mean(unlist(lapply(Weibull_N_param_list6[[1]], function(matrix) matrix[, 1]))))*(29 -
                               (mean(unlist(lapply(Weibull_N_param_list6[[2]], function(matrix) matrix[, 1])))))^2 +
                               mean(unlist(lapply(Weibull_N_param_list6[[3]], function(matrix) matrix[, 1]))))/log(2)^(1/mean(unlist(lapply(Weibull_N_param_list6[[5]], function(matrix) matrix[, 1])))),shape=mean(unlist(lapply(Weibull_N_param_list6[[5]], function(matrix) matrix[, 1])))),plot.it=FALSE)
...
summary_list.wb_N <- list(
  xdf1_W_N |> summarize(RMSE = sqrt(mean((value - 1/true.value)^2))),
  xdf2_W_N |> summarize(RMSE = sqrt(mean((value - 1/true.value)^2))),
  xdf3_W_N |> summarize(RMSE = sqrt(mean((value - 1/true.value)^2))),
  xdf4_W_N |> summarize(RMSE = sqrt(mean((value - 1/true.value)^2))),
  xdf5_W_N |> summarize(RMSE = sqrt(mean((value - 1/true.value)^2))),
  xdf6_W_N |> summarize(RMSE = sqrt(mean((value - 1/true.value)^2)))
)
...
N_data.rmse.ind.wb <- function(temp, values, a, Topt, c) {
  curve_value <- 1/(exp(mean(unlist(lapply(Weibull_N_param_list1[[1]], function(matrix) matrix[, 1])))) * (temp - 
    mean(unlist(lapply(Weibull_N_param_list1[[2]], function(matrix) matrix[, 1]))))^2 + 
    mean(unlist(lapply(Weibull_N_param_list1[[3]], function(matrix) matrix[, 1]))))
  sqrt(mean((values - curve_value)^2))
}
...
N_data.rmse.mean.wb <- function(temp, values, a, Topt, c) {
  curve_value <- 1/(exp(mean(unlist(lapply(Weibull_N_param_list2[[1]], function(matrix) matrix[, 1])))) * (temp - 
    mean(unlist(lapply(Weibull_N_param_list2[[2]], function(matrix) matrix[, 1]))))^2 + 
    mean(unlist(lapply(Weibull_N_param_list2[[3]], function(matrix) matrix[, 1]))))
  sqrt(mean((values - curve_value)^2))
}
...
N_data.rmse.inv.wb <- function(temp, values, a, Topt, c) {
  curve_value <- 1/(exp(mean(unlist(lapply(Weibull_N_param_list3[[1]], function(matrix) matrix[, 1])))) * (temp - 
    mean(unlist(lapply(Weibull_N_param_list3[[2]], function(matrix) matrix[, 1]))))^2 + 
    mean(unlist(lapply(Weibull_N_param_list3[[3]], function(matrix) matrix[, 1]))))
  sqrt(mean((values - curve_value)^2))
}
...
N_data.rmse.mean.inv.wb <- function(temp, values, a, Topt, c) {
  curve_value <- 1/(exp(mean(unlist(lapply(Weibull_N_param_list4[[1]], function(matrix) matrix[, 1])))) * (temp - 
    mean(unlist(lapply(Weibull_N_param_list4[[2]], function(matrix) matrix[, 1]))))^2 + 
    mean(unlist(lapply(Weibull_N_param_list4[[3]], function(matrix) matrix[, 1]))))
  sqrt(mean((values - curve_value)^2))
}
...
N_data.rmse.inv.mean.wb <- function(temp, values, a, Topt, c) {
  curve_value <- 1/(exp(mean(unlist(lapply(Weibull_N_param_list5[[1]], function(matrix) matrix[, 1])))) * (temp - 
    mean(unlist(lapply(Weibull_N_param_list5[[2]], function(matrix) matrix[, 1]))))^2 + 
    mean(unlist(lapply(Weibull_N_param_list5[[3]], function(matrix) matrix[, 1]))))
  sqrt(mean((values - curve_value)^2))
}
...
N_data.rmse.wb.wb <- function(temp, values, a, Topt, c) {
  curve_value <- 1/(exp(mean(unlist(lapply(Weibull_N_param_list6[[1]], function(matrix) matrix[, 1])))) * (temp - 
    mean(unlist(lapply(Weibull_N_param_list6[[2]], function(matrix) matrix[, 1]))))^2 + 
    mean(unlist(lapply(Weibull_N_param_list6[[3]], function(matrix) matrix[, 1]))))
  sqrt(mean((values - curve_value)^2))
}
