...
df.outliers <- df.outliers[, list(x.outliers = c(unlist(df.outliers$x.outliers),rep(NA,53)), y.outliers = c(unlist(df.outliers$y.outliers))),
...
ggplot(data=dub.wb[1:6,], aes(fill = Method, color = Method)) +
  ...
  facet_wrap(dub.wb$Method[1:6],nrow=2, scales = "free_y")+
  theme(legend.position="none")+
  labs(title= "Boxplot of Topt and Lifetime",
       x="Topt",
       y="Lifetime")
...
ggplot(data=dub.ex[1:5,], aes(fill = Method, color = Method)) +
  ...
  theme_classic()+
  facet_wrap(dub.ex$Method[1:5],nrow=2, scales = "free_y")+
...
ggplot(data=dub.ex.wb[1:6,], aes(fill = Method, color = Method)) +
  ...
  theme_classic()+
  facet_wrap(dub.ex.wb$Method[1:6],nrow=2, scales = "free_y")+
