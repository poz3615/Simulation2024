...
gridExtra::grid.arrange(wb.exp.plot.mr, wb.exp.plot.life, nrow = 1, widths = c(1, 1.75))
exp_wb_model_compare <- gridExtra::arrangeGrob(wb.exp.plot.mr, wb.exp.plot.life, nrow = 1, widths = c(1, 1.25))
