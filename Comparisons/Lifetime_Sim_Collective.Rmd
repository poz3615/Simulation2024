...
dub$Method <-factor(dub$Method, levels = c("Individual Exp Data, Exp Model","Mean Exp Data, Exp Model", "Individual Inverse Exp Data, Exp Model",
               "Mean Inverse Exp Data, Exp Model", "Inverse Mean Exp Data, Exp Model", "True Curve"))
...
ggplot(data=dub.ex[1:5,], aes(fill = Method, color = Method)) +
  ...
  theme_classic()+
  facet_wrap(dub.ex$Method[1:5],nrow=2)+
...
plot(inv.mean.exp.10,pch=20,xlim=c(0,5),ylim=c(0,5), col = viridis(5)[1],
...
plot(ind.wb.10,xlim=c(0,35),ylim=c(0,35),pch=20, col = viridis(5)[1],
...
plot(mean.wb.10,pch=20,xlim=c(0,60),ylim=c(0,30), col = viridis(5)[1],
...
plot(inv.wb.10,xlim=c(0,50),ylim=c(0,3),pch=20, col = viridis(5)[1],
...
```{r RMSE.Boxplot.Exp}
xdf1$true.value<-rep(true_curve(seq(from = 5, to = 37, length.out = 250)),938)
xdf2$true.value<-rep(true_curve(seq(from = 5, to = 37, length.out = 250)),938)
xdf3$true.value<-rep(true_curve(seq(from = 5, to = 37, length.out = 250)),938)
xdf4$true.value<-rep(true_curve(seq(from = 5, to = 37, length.out = 250)),938)
xdf5$true.value<-rep(true_curve(seq(from = 5, to = 37, length.out = 250)),938)
...
boxplot.df<-data.frame(
  Method=factor(c(rep("Individual Exp Data, Exp Model",250),rep("Mean Exp Data, Exp Model",250),rep("Individual Inverse Exp Data, Exp Model",250),rep("Mean Inverse Exp Data, Exp Model",250),rep("Inverse Mean Exp Data, Exp Model",250)),levels=rev(c("Inverse Mean Exp Data, Exp Model","Mean Inverse Exp Data, Exp Model","Individual Inverse Exp Data, Exp Model",
...
ggplot() +
  ...
  theme_minimal()
ggplot() +
  geom_line(data=N_mean.xdf5, aes(x = point,y = med.value), color = cividis(10)[1],lwd=1) +
  geom_ribbon(data=N_mean.xdf5, aes(ymin = lower.hdi, ymax = upper.hdi, x=point), fill = cividis(10)[1], alpha = 0.3) +
  geom_line(data=mean.xdf5, aes(x = point,y = med.value), color = rocket(10)[5],lwd=1) +
  geom_ribbon(data=mean.xdf5, aes(ymin = lower.hdi, ymax = upper.hdi, x=point), fill = rocket(10)[5], alpha = 0.2) +
...
ggplot() +
  ...
  theme_minimal()
ggplot() +
  geom_line(data=N_mean.xdf5, aes(x = point,y = med.value.inv), color = cividis(10)[1],lwd=1) +
  geom_ribbon(data=N_mean.xdf5, aes(ymin = lower.hdi.inv, ymax = upper.hdi.inv, x=point), fill = cividis(10)[1], alpha = 0.3) +
  geom_line(data=mean.xdf5, aes(x = point,y = med.value.inv), color = rocket(10)[5],lwd=1) +
  geom_ribbon(data=mean.xdf5, aes(ymin = lower.hdi.inv, ymax = upper.hdi.inv, x=point), fill = rocket(10)[5], alpha = 0.2) +
