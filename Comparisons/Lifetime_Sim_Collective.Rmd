...
df.a <- data.frame(
  ...
  Median = c(exp(median(unlist(lapply(param_list1[[1]], function(matrix) matrix[, 2])))), 
           exp(median(unlist(lapply(param_list2[[1]], function(matrix) matrix[, 2])))), 
           exp(median(unlist(lapply(param_list3[[1]], function(matrix) matrix[, 2])))), 
           exp(median(unlist(lapply(param_list4[[1]], function(matrix) matrix[, 2])))), 
           exp(median(unlist(lapply(param_list5[[1]], function(matrix) matrix[, 2]))))), 
  upper = c(exp(hdi(unlist(lapply(param_list1[[1]], function(matrix) matrix[, 2])))[2]), 
            exp(hdi(unlist(lapply(param_list2[[1]], function(matrix) matrix[, 2])))[2]), 
            exp(hdi(unlist(lapply(param_list3[[1]], function(matrix) matrix[, 2])))[2]), 
            exp(hdi(unlist(lapply(param_list4[[1]], function(matrix) matrix[, 2])))[2]), 
            exp(hdi(unlist(lapply(param_list5[[1]], function(matrix) matrix[, 2])))[2])), 
  lower = c(exp(hdi(unlist(lapply(param_list1[[1]], function(matrix) matrix[, 2])))[1]), 
            exp(hdi(unlist(lapply(param_list2[[1]], function(matrix) matrix[, 2])))[1]), 
            exp(hdi(unlist(lapply(param_list3[[1]], function(matrix) matrix[, 2])))[1]), 
            exp(hdi(unlist(lapply(param_list4[[1]], function(matrix) matrix[, 2])))[1]), 
            exp(hdi(unlist(lapply(param_list5[[1]], function(matrix) matrix[, 2])))[1]))
)
...
df.b <- data.frame(
  x = factor(c("Individual Exp Data, Exp Model", "Mean Exp Data, Exp Model", "Individual Inverse Exp Data, Trunc Norm Model", 
               "Mean Inverse Exp Data, Trunc Norm Model", "Inverse Mean Exp Data, Trunc Norm Model")), 
  Median = c(median(unlist(lapply(param_list1[[2]], function(matrix) matrix[, 2]))), 
           median(unlist(lapply(param_list2[[2]], function(matrix) matrix[, 2]))), 
           median(unlist(lapply(param_list3[[2]], function(matrix) matrix[, 2]))), 
           median(unlist(lapply(param_list4[[2]], function(matrix) matrix[, 2]))), 
           median(unlist(lapply(param_list5[[2]], function(matrix) matrix[, 2])))), 
  upper = c(hdi(unlist(lapply(param_list1[[2]], function(matrix) matrix[, 2])))[2], 
            hdi(unlist(lapply(param_list2[[2]], function(matrix) matrix[, 2])))[2], 
            hdi(unlist(lapply(param_list3[[2]], function(matrix) matrix[, 2])))[2], 
            hdi(unlist(lapply(param_list4[[2]], function(matrix) matrix[, 2])))[2], 
            hdi(unlist(lapply(param_list5[[2]], function(matrix) matrix[, 2])))[2]), 
  lower = c(hdi(unlist(lapply(param_list1[[2]], function(matrix) matrix[, 2])))[1], 
            hdi(unlist(lapply(param_list2[[2]], function(matrix) matrix[, 2])))[1], 
            hdi(unlist(lapply(param_list3[[2]], function(matrix) matrix[, 2])))[1], 
            hdi(unlist(lapply(param_list4[[2]], function(matrix) matrix[, 2])))[1], 
            hdi(unlist(lapply(param_list5[[2]], function(matrix) matrix[, 2])))[1])
)
...
df.c <- data.frame(
  x = factor(c("Individual Exp Data, Exp Model", "Mean Exp Data, Exp Model", "Individual Inverse Exp Data, Trunc Norm Model", 
               "Mean Inverse Exp Data, Trunc Norm Model", "Inverse Mean Exp Data, Trunc Norm Model")), 
  Median = c((median(unlist(lapply(param_list1[[3]], function(matrix) matrix[, 2])))), 
  ...
  upper = c((hdi(unlist(lapply(param_list1[[3]], function(matrix) matrix[, 2])))[2]), 
            (hdi(unlist(lapply(param_list2[[3]], function(matrix) matrix[, 2])))[2]), 
            (hdi(unlist(lapply(param_list3[[3]], function(matrix) matrix[, 2])))[2]), 
            (hdi(unlist(lapply(param_list4[[3]], function(matrix) matrix[, 2])))[2]), 
            (hdi(unlist(lapply(param_list5[[3]], function(matrix) matrix[, 2])))[2])), 
  lower = c((hdi(unlist(lapply(param_list1[[3]], function(matrix) matrix[, 2])))[1]), 
            (hdi(unlist(lapply(param_list2[[3]], function(matrix) matrix[, 2])))[1]), 
            (hdi(unlist(lapply(param_list3[[3]], function(matrix) matrix[, 2])))[1]), 
            (hdi(unlist(lapply(param_list4[[3]], function(matrix) matrix[, 2])))[1]), 
            (hdi(unlist(lapply(param_list5[[3]], function(matrix) matrix[, 2])))[1]))
)
...
desired_order.wb <- c("Inverse Mean WB Data, Trunc Norm Model", "Mean Inverse WB Data, Trunc Norm Model", 
                      "Individual Inverse WB Data, Trunc Norm Model", "Mean WB Data, Exp Model", "Individual WB Data, Exp Model", "Individual WB Data, WB Model")

df.a.wb <- data.frame(
  x = factor(c("Individual WB Data, WB Model", "Individual WB Data, Exp Model", "Mean WB Data, Exp Model", "Individual Inverse WB Data, Trunc Norm Model", 
               "Mean Inverse WB Data, Trunc Norm Model", "Inverse Mean WB Data, Trunc Norm Model")), 
  Median = c(exp(median(unlist(lapply(Weibull_param_list6[[1]], function(matrix) matrix[, 2])))),
           exp(median(unlist(lapply(Weibull_param_list1[[1]], function(matrix) matrix[, 2])))), 
           exp(median(unlist(lapply(Weibull_param_list2[[1]], function(matrix) matrix[, 2])))), 
           exp(median(unlist(lapply(Weibull_param_list3[[1]], function(matrix) matrix[, 2])))), 
           exp(median(unlist(lapply(Weibull_param_list4[[1]], function(matrix) matrix[, 2])))), 
           exp(median(unlist(lapply(Weibull_param_list5[[1]], function(matrix) matrix[, 2]))))), 
  upper = c(exp(hdi(unlist(lapply(Weibull_param_list6[[1]], function(matrix) matrix[, 2])))[2]),
            exp(hdi(unlist(lapply(Weibull_param_list1[[1]], function(matrix) matrix[, 2])))[2]), 
            exp(hdi(unlist(lapply(Weibull_param_list2[[1]], function(matrix) matrix[, 2])))[2]), 
            exp(hdi(unlist(lapply(Weibull_param_list3[[1]], function(matrix) matrix[, 2])))[2]), 
            exp(hdi(unlist(lapply(Weibull_param_list4[[1]], function(matrix) matrix[, 2])))[2]), 
            exp(hdi(unlist(lapply(Weibull_param_list5[[1]], function(matrix) matrix[, 2])))[2])), 
  lower = c(exp(hdi(unlist(lapply(Weibull_param_list6[[1]], function(matrix) matrix[, 2])))[1]),
            exp(hdi(unlist(lapply(Weibull_param_list1[[1]], function(matrix) matrix[, 2])))[1]), 
            exp(hdi(unlist(lapply(Weibull_param_list2[[1]], function(matrix) matrix[, 2])))[1]), 
            exp(hdi(unlist(lapply(Weibull_param_list3[[1]], function(matrix) matrix[, 2])))[1]), 
            exp(hdi(unlist(lapply(Weibull_param_list4[[1]], function(matrix) matrix[, 2])))[1]), 
            exp(hdi(unlist(lapply(Weibull_param_list5[[1]], function(matrix) matrix[, 2])))[1]))
)
...
df.b.wb <- data.frame(
  x = factor(c("Individual WB Data, WB Model", "Individual WB Data, Exp Model", "Mean WB Data, Exp Model", "Individual Inverse WB Data, Trunc Norm Model", 
               "Mean Inverse WB Data, Trunc Norm Model", "Inverse Mean WB Data, Trunc Norm Model")),
  Median = c(median(unlist(lapply(Weibull_param_list6[[2]], function(matrix) matrix[, 2]))),
             median(unlist(lapply(Weibull_param_list1[[2]], function(matrix) matrix[, 2]))), 
           median(unlist(lapply(Weibull_param_list2[[2]], function(matrix) matrix[, 2]))), 
           median(unlist(lapply(Weibull_param_list3[[2]], function(matrix) matrix[, 2]))), 
           median(unlist(lapply(Weibull_param_list4[[2]], function(matrix) matrix[, 2]))), 
           median(unlist(lapply(Weibull_param_list5[[2]], function(matrix) matrix[, 2])))), 
  upper = c(hdi(unlist(lapply(Weibull_param_list6[[2]], function(matrix) matrix[, 2])))[2],
            hdi(unlist(lapply(Weibull_param_list1[[2]], function(matrix) matrix[, 2])))[2], 
            hdi(unlist(lapply(Weibull_param_list2[[2]], function(matrix) matrix[, 2])))[2], 
            hdi(unlist(lapply(Weibull_param_list3[[2]], function(matrix) matrix[, 2])))[2], 
            hdi(unlist(lapply(Weibull_param_list4[[2]], function(matrix) matrix[, 2])))[2], 
            hdi(unlist(lapply(Weibull_param_list5[[2]], function(matrix) matrix[, 2])))[2]), 
  lower = c(hdi(unlist(lapply(Weibull_param_list6[[2]], function(matrix) matrix[, 2])))[1],
            hdi(unlist(lapply(Weibull_param_list1[[2]], function(matrix) matrix[, 2])))[1], 
            hdi(unlist(lapply(Weibull_param_list2[[2]], function(matrix) matrix[, 2])))[1], 
            hdi(unlist(lapply(Weibull_param_list3[[2]], function(matrix) matrix[, 2])))[1], 
            hdi(unlist(lapply(Weibull_param_list4[[2]], function(matrix) matrix[, 2])))[1], 
            hdi(unlist(lapply(Weibull_param_list5[[2]], function(matrix) matrix[, 2])))[1])
)
...
df.c.wb <- data.frame(
  x = factor(c("Individual WB Data, WB Model", "Individual WB Data, Exp Model", "Mean WB Data, Exp Model", "Individual Inverse WB Data, Trunc Norm Model", 
               "Mean Inverse WB Data, Trunc Norm Model", "Inverse Mean WB Data, Trunc Norm Model")),
  Median = c((median(unlist(lapply(Weibull_param_list6[[3]], function(matrix) matrix[, 2])))),
  ...
  upper = c((hdi(unlist(lapply(Weibull_param_list6[[3]], function(matrix) matrix[, 2])))[2]),
            (hdi(unlist(lapply(Weibull_param_list1[[3]], function(matrix) matrix[, 2])))[2]), 
            (hdi(unlist(lapply(Weibull_param_list2[[3]], function(matrix) matrix[, 2])))[2]), 
            (hdi(unlist(lapply(Weibull_param_list3[[3]], function(matrix) matrix[, 2])))[2]), 
            (hdi(unlist(lapply(Weibull_param_list4[[3]], function(matrix) matrix[, 2])))[2]), 
            (hdi(unlist(lapply(Weibull_param_list5[[3]], function(matrix) matrix[, 2])))[2])), 
  lower = c((hdi(unlist(lapply(Weibull_param_list6[[3]], function(matrix) matrix[, 2])))[1]),
            (hdi(unlist(lapply(Weibull_param_list1[[3]], function(matrix) matrix[, 2])))[1]), 
            (hdi(unlist(lapply(Weibull_param_list2[[3]], function(matrix) matrix[, 2])))[1]), 
            (hdi(unlist(lapply(Weibull_param_list3[[3]], function(matrix) matrix[, 2])))[1]), 
            (hdi(unlist(lapply(Weibull_param_list4[[3]], function(matrix) matrix[, 2])))[1]), 
            (hdi(unlist(lapply(Weibull_param_list5[[3]], function(matrix) matrix[, 2])))[1]))
)
...
for (df_index.wb in 1:length(df_list.wb)) {
  ...
  if (df_index.wb  ==  2 || df_index.wb  ==  3) {
    a_col <- 3
    Topt_col <- 4
    c_col <- 1
  } else {
...
double.box.df.wb <- data.frame(
  Topt = c(min_x_values_list.wb[[6]],
           min_x_values_list.wb[[1]], 
           min_x_values_list.wb[[2]], 
           min_x_values_list.wb[[3]], 
           min_x_values_list.wb[[4]], 
           min_x_values_list.wb[[5]], 
           22.3), 
  Lifetime = c(1/min_values_list.wb[[6]], 
               1/min_values_list.wb[[1]], 
               1/min_values_list.wb[[2]], 
               1/min_values_list.wb[[3]], 
               1/min_values_list.wb[[4]], 
               1/min_values_list.wb[[5]],
               15.433231), 
  Method = factor(c( rep("Individual WB Data, WB Model", 938), rep("Individual WB Data, Exp Model", 938), rep("Mean WB Data, Exp Model", 938), rep("Individual Inverse WB Data, Trunc Norm Model", 938), 
               rep("Mean Inverse WB Data, Trunc Norm Model", 938), rep("Inverse Mean WB Data, Trunc Norm Model", 938), "True Curve"), 
               levels = c("Individual WB Data, WB Model", "Individual WB Data, Exp Model", "Mean WB Data, Exp Model", "Individual Inverse WB Data, Trunc Norm Model", 
               "Mean Inverse WB Data, Trunc Norm Model", "Inverse Mean WB Data, Trunc Norm Model", 
                "True Curve")
               )
)
...
df.wb$Method <- factor(c("Individual WB Data, WB Model", "Individual WB Data, Exp Model", "Mean WB Data, Exp Model", "Individual Inverse WB Data, Trunc Norm Model", 
               "Mean Inverse WB Data, Trunc Norm Model", "Inverse Mean WB Data, Trunc Norm Model", 
                "True Curve"))
...
dub.wb$Method <- factor(dub.wb$Method, levels = c("Individual WB Data, WB Model", "Individual WB Data, Exp Model", "Mean WB Data, Exp Model", "Individual Inverse WB Data, Trunc Norm Model", 
               "Mean Inverse WB Data, Trunc Norm Model", "Inverse Mean WB Data, Trunc Norm Model", 
                "True Curve"))
...
double.box.df.ex.wb$Method <- factor(c(rep("Individual WB Data, WB Model", 938), rep("Individual WB Data, Exp Model", 938), rep("Mean WB Data, Exp Model", 938), rep("Individual Inverse WB Data, Trunc Norm Model", 938), 
               rep("Mean Inverse WB Data, Trunc Norm Model", 938), rep("Inverse Mean WB Data, Trunc Norm Model", 938), "True Curve" 
               ), 
               levels = c("Individual WB Data, Exp Model", "Mean WB Data, Exp Model", "Individual Inverse WB Data, Trunc Norm Model", 
               "Mean Inverse WB Data, Trunc Norm Model", "Inverse Mean WB Data, Trunc Norm Model", "Individual WB Data, WB Model", "True Curve")
)
...
dub.ex.wb$Method <- factor(dub.ex.wb$Method, levels = c("Individual WB Data, WB Model", "Individual WB Data, Exp Model", "Mean WB Data, Exp Model", "Individual Inverse WB Data, Trunc Norm Model", 
...
df.ex.wb$Method <- factor(c("Individual WB Data, WB Model", "Individual WB Data, Exp Model", "Mean WB Data, Exp Model", "Individual Inverse WB Data, Trunc Norm Model", 
               "Mean Inverse WB Data, Trunc Norm Model", "Inverse Mean WB Data, Trunc Norm Model", "True Curve"))
...
mean.exp.10 <- qqPlot(df.mean.mean.exp$trait[df.mean.mean.exp$T == 10], 
       distribution = "exp", 
       param.list = list(rate = (exp(median(unlist(lapply(param_list2[[1]], function(matrix) matrix[, 2])))) * (10 - 
                               median(unlist(lapply(param_list2[[2]], function(matrix) matrix[, 2]))))^2  + 
                               median(unlist(lapply(param_list2[[3]], function(matrix) matrix[, 2]))))), plot.it = FALSE)

mean.exp.17 <- qqPlot(df.mean.mean.exp$trait[df.mean.mean.exp$T == 17], 
       distribution = "exp", 
       param.list = list(rate = (exp(median(unlist(lapply(param_list2[[1]], function(matrix) matrix[, 2])))) * (17 - 
                               median(unlist(lapply(param_list2[[2]], function(matrix) matrix[, 2]))))^2  + 
                               median(unlist(lapply(param_list2[[3]], function(matrix) matrix[, 2]))))), plot.it = FALSE)

mean.exp.21 <- qqPlot(df.mean.mean.exp$trait[df.mean.mean.exp$T == 21], 
       distribution = "exp", 
       param.list = list(rate = (exp(median(unlist(lapply(param_list2[[1]], function(matrix) matrix[, 2])))) * (21 - 
                               median(unlist(lapply(param_list2[[2]], function(matrix) matrix[, 2]))))^2  + 
                               median(unlist(lapply(param_list2[[3]], function(matrix) matrix[, 2]))))), plot.it = FALSE)

mean.exp.25 <- qqPlot(df.mean.mean.exp$trait[df.mean.mean.exp$T == 25], 
       distribution = "exp", 
       param.list = list(rate = (exp(median(unlist(lapply(param_list2[[1]], function(matrix) matrix[, 2])))) * (25 - 
                               median(unlist(lapply(param_list2[[2]], function(matrix) matrix[, 2]))))^2  + 
                               median(unlist(lapply(param_list2[[3]], function(matrix) matrix[, 2]))))), plot.it = FALSE)

mean.exp.32 <- qqPlot(df.mean.mean.exp$trait[df.mean.mean.exp$T == 32], 
       distribution = "exp", 
       param.list = list(rate = (exp(median(unlist(lapply(param_list2[[1]], function(matrix) matrix[, 2])))) * (32 - 
                               median(unlist(lapply(param_list2[[2]], function(matrix) matrix[, 2]))))^2  + 
                               median(unlist(lapply(param_list2[[3]], function(matrix) matrix[, 2]))))), plot.it = FALSE)
...
ind.wb.10 <- qqPlot(Weibull_data.list[[100]]$trait[Weibull_data.list[[100]]$T == 10], 
       distribution = "exp", 
       param.list = list(rate = exp(exp(median(unlist(lapply(Weibull_param_list1[[1]], function(matrix) matrix[, 2])))) * (10 - 
                               (median(unlist(lapply(Weibull_param_list1[[2]], function(matrix) matrix[, 2])))))^2  + 
...
ind.wb.17 <- qqPlot(Weibull_data.list[[100]]$trait[Weibull_data.list[[100]]$T == 17], 
       distribution = "exp", 
       param.list = list(rate = exp(exp(median(unlist(lapply(Weibull_param_list1[[1]], function(matrix) matrix[, 2])))) * (17 - 
                               (median(unlist(lapply(Weibull_param_list1[[2]], function(matrix) matrix[, 2])))))^2  + 
                               median(unlist(lapply(Weibull_param_list1[[3]], function(matrix) matrix[, 2]))))), plot.it = FALSE)

ind.wb.21 <- qqPlot(Weibull_data.list[[100]]$trait[Weibull_data.list[[100]]$T == 21], 
       distribution = "exp", 
       param.list = list(rate = exp(exp(median(unlist(lapply(Weibull_param_list1[[1]], function(matrix) matrix[, 2])))) * (21 - 
                               (median(unlist(lapply(Weibull_param_list1[[2]], function(matrix) matrix[, 2])))))^2  + 
                               median(unlist(lapply(Weibull_param_list1[[3]], function(matrix) matrix[, 2]))))), plot.it = FALSE)

ind.wb.25 <- qqPlot(Weibull_data.list[[100]]$trait[Weibull_data.list[[100]]$T == 25], 
       distribution = "exp", 
       param.list = list(rate = exp(exp(median(unlist(lapply(Weibull_param_list1[[1]], function(matrix) matrix[, 2])))) * (25 - 
                               (median(unlist(lapply(Weibull_param_list1[[2]], function(matrix) matrix[, 2])))))^2  + 
                               median(unlist(lapply(Weibull_param_list1[[3]], function(matrix) matrix[, 2]))))), plot.it = FALSE)

ind.wb.32 <- qqPlot(Weibull_data.list[[100]]$trait[Weibull_data.list[[100]]$T == 32], 
       distribution = "exp", 
       param.list = list(rate = exp(exp(median(unlist(lapply(Weibull_param_list1[[1]], function(matrix) matrix[, 2])))) * (32 - 
                               (median(unlist(lapply(Weibull_param_list1[[2]], function(matrix) matrix[, 2])))))^2  + 
                               median(unlist(lapply(Weibull_param_list1[[3]], function(matrix) matrix[, 2]))))), plot.it = FALSE)
...
mean.wb.10 <- qqPlot(df.mean.mean.wb$trait[df.mean.mean.wb$T == 10], 
       distribution = "exp", 
       param.list = list(rate = exp(exp(median(unlist(lapply(Weibull_param_list2[[1]], function(matrix) matrix[, 2])))) * (10 - 
                               (median(unlist(lapply(Weibull_param_list2[[2]], function(matrix) matrix[, 2])))))^2  + 
                               median(unlist(lapply(Weibull_param_list2[[3]], function(matrix) matrix[, 2]))))), plot.it = FALSE)

mean.wb.17 <- qqPlot(df.mean.mean.wb$trait[df.mean.mean.wb$T == 17], 
       distribution = "exp", 
       param.list = list(rate = exp(exp(median(unlist(lapply(Weibull_param_list2[[1]], function(matrix) matrix[, 2])))) * (17 - 
                               (median(unlist(lapply(Weibull_param_list2[[2]], function(matrix) matrix[, 2])))))^2  + 
                               median(unlist(lapply(Weibull_param_list2[[3]], function(matrix) matrix[, 2]))))), plot.it = FALSE)

mean.wb.21 <- qqPlot(df.mean.mean.wb$trait[df.mean.mean.wb$T == 21], 
       distribution = "exp", 
       param.list = list(rate = exp(exp(median(unlist(lapply(Weibull_param_list2[[1]], function(matrix) matrix[, 2])))) * (21 - 
                               (median(unlist(lapply(Weibull_param_list2[[2]], function(matrix) matrix[, 2])))))^2  + 
                               median(unlist(lapply(Weibull_param_list2[[3]], function(matrix) matrix[, 2]))))), plot.it = FALSE)

mean.wb.25 <- qqPlot(df.mean.mean.wb$trait[df.mean.mean.wb$T == 25], 
       distribution = "exp", 
       param.list = list(rate = exp(exp(median(unlist(lapply(Weibull_param_list2[[1]], function(matrix) matrix[, 2])))) * (25 - 
                               (median(unlist(lapply(Weibull_param_list2[[2]], function(matrix) matrix[, 2])))))^2  + 
                               median(unlist(lapply(Weibull_param_list2[[3]], function(matrix) matrix[, 2]))))), plot.it = FALSE)

mean.wb.32 <- qqPlot(df.mean.mean.wb$trait[df.mean.mean.wb$T == 32], 
       distribution = "exp", 
       param.list = list(rate = exp(exp(median(unlist(lapply(Weibull_param_list2[[1]], function(matrix) matrix[, 2])))) * (32 - 
                               (median(unlist(lapply(Weibull_param_list2[[2]], function(matrix) matrix[, 2])))))^2  + 
                               median(unlist(lapply(Weibull_param_list2[[3]], function(matrix) matrix[, 2]))))), plot.it = FALSE)
...
inv.wb.10 <- qqPlot(1/Weibull_data.list[[100]]$trait[Weibull_data.list[[100]]$T == 10], 
       distribution = "normTrunc", 
       param.list = list(mean = exp(exp(median(unlist(lapply(Weibull_param_list3[[1]], function(matrix) matrix[, 2])))) * (10 - 
                               (median(unlist(lapply(Weibull_param_list3[[2]], function(matrix) matrix[, 2])))))^2  + 
                               median(unlist(lapply(Weibull_param_list3[[3]], function(matrix) matrix[, 2])))), 
...
inv.wb.17 <- qqPlot(1/Weibull_data.list[[100]]$trait[Weibull_data.list[[100]]$T == 17], 
       distribution = "normTrunc", 
       param.list = list(mean = exp(exp(median(unlist(lapply(Weibull_param_list3[[1]], function(matrix) matrix[, 2])))) * (17 - 
                               (median(unlist(lapply(Weibull_param_list3[[2]], function(matrix) matrix[, 2])))))^2  + 
                               median(unlist(lapply(Weibull_param_list3[[3]], function(matrix) matrix[, 2])))), 
                       sd = 1/median(unlist(lapply(Weibull_param_list3[[5]], function(matrix) matrix[, 2]))), 
                       min = 0, 
...
inv.wb.21 <- qqPlot(1/Weibull_data.list[[100]]$trait[Weibull_data.list[[100]]$T == 21], 
       distribution = "normTrunc", 
       param.list = list(mean = exp(exp(median(unlist(lapply(Weibull_param_list3[[1]], function(matrix) matrix[, 2])))) * (21 - 
                               (median(unlist(lapply(Weibull_param_list3[[2]], function(matrix) matrix[, 2])))))^2  + 
                               median(unlist(lapply(Weibull_param_list3[[3]], function(matrix) matrix[, 2])))), 
                       sd = 1/median(unlist(lapply(Weibull_param_list3[[5]], function(matrix) matrix[, 2]))), 
                       min = 0, 
...
inv.wb.25 <- qqPlot(1/Weibull_data.list[[100]]$trait[Weibull_data.list[[100]]$T == 25], 
       distribution = "normTrunc", 
       param.list = list(mean = exp(exp(median(unlist(lapply(Weibull_param_list3[[1]], function(matrix) matrix[, 2])))) * (25 - 
                               (median(unlist(lapply(Weibull_param_list3[[2]], function(matrix) matrix[, 2])))))^2  + 
                               median(unlist(lapply(Weibull_param_list3[[3]], function(matrix) matrix[, 2])))), 
                       sd = 1/median(unlist(lapply(Weibull_param_list3[[5]], function(matrix) matrix[, 2]))), 
                       min = 0, 
...
inv.wb.32 <- qqPlot(1/Weibull_data.list[[100]]$trait[Weibull_data.list[[100]]$T == 32], 
       distribution = "normTrunc", 
        param.list = list(mean = exp(exp(median(unlist(lapply(Weibull_param_list3[[1]], function(matrix) matrix[, 2])))) * (32 - 
                               (median(unlist(lapply(Weibull_param_list3[[2]], function(matrix) matrix[, 2])))))^2  + 
                               median(unlist(lapply(Weibull_param_list3[[3]], function(matrix) matrix[, 2])))), 
                       sd = 1/median(unlist(lapply(Weibull_param_list3[[5]], function(matrix) matrix[, 2]))), 
                       min = 0, 
...
mean.inv.wb.10 <- qqPlot(df.mean.mean.wb$trait[df.mean.mean.wb$T == 10], 
       distribution = "normTrunc", 
       param.list = list(mean = exp(exp(median(unlist(lapply(Weibull_param_list4[[1]], function(matrix) matrix[, 2])))) * (10 - 
                               (median(unlist(lapply(Weibull_param_list4[[2]], function(matrix) matrix[, 2])))))^2  + 
                               median(unlist(lapply(Weibull_param_list4[[3]], function(matrix) matrix[, 2])))), 
...
mean.inv.wb.17 <- qqPlot(df.mean.mean.wb$trait[df.mean.mean.wb$T == 17], 
       distribution = "normTrunc", 
       param.list = list(mean = exp(exp(median(unlist(lapply(Weibull_param_list4[[1]], function(matrix) matrix[, 2])))) * (17 - 
                               (median(unlist(lapply(Weibull_param_list4[[2]], function(matrix) matrix[, 2])))))^2  + 
                               median(unlist(lapply(Weibull_param_list4[[3]], function(matrix) matrix[, 2])))), 
                       sd = 1/median(unlist(lapply(Weibull_param_list4[[5]], function(matrix) matrix[, 2]))), 
                       min = 0, 
...
mean.inv.wb.21 <- qqPlot(df.mean.mean.wb$trait[df.mean.mean.wb$T == 21], 
       distribution = "normTrunc", 
       param.list = list(mean = exp(exp(median(unlist(lapply(Weibull_param_list4[[1]], function(matrix) matrix[, 2])))) * (21 - 
                               (median(unlist(lapply(Weibull_param_list4[[2]], function(matrix) matrix[, 2])))))^2  + 
                               median(unlist(lapply(Weibull_param_list4[[3]], function(matrix) matrix[, 2])))), 
                       sd = 1/median(unlist(lapply(Weibull_param_list4[[5]], function(matrix) matrix[, 2]))), 
                       min = 0, 
...
mean.inv.wb.25 <- qqPlot(df.mean.mean.wb$trait[df.mean.mean.wb$T == 25], 
       distribution = "normTrunc", 
       param.list = list(mean = exp(exp(median(unlist(lapply(Weibull_param_list4[[1]], function(matrix) matrix[, 2])))) * (25 - 
                               (median(unlist(lapply(Weibull_param_list4[[2]], function(matrix) matrix[, 2])))))^2  + 
                               median(unlist(lapply(Weibull_param_list4[[3]], function(matrix) matrix[, 2])))), 
                       sd = 1/median(unlist(lapply(Weibull_param_list4[[5]], function(matrix) matrix[, 2]))), 
                       min = 0, 
...
mean.inv.wb.32 <- qqPlot(df.mean.mean.wb$trait[df.mean.mean.wb$T == 32], 
       distribution = "normTrunc", 
       param.list = list(mean = exp(exp(median(unlist(lapply(Weibull_param_list4[[1]], function(matrix) matrix[, 2])))) * (32 - 
                               (median(unlist(lapply(Weibull_param_list4[[2]], function(matrix) matrix[, 2])))))^2  + 
                               median(unlist(lapply(Weibull_param_list4[[3]], function(matrix) matrix[, 2])))), 
                       sd = 1/median(unlist(lapply(Weibull_param_list4[[5]], function(matrix) matrix[, 2]))), 
                       min = 0, 
...
inv.mean.wb.10 <- qqPlot(df.mean.inv.wb$trait[df.mean.inv.wb$T == 10], 
       distribution = "normTrunc", 
       param.list = list(mean = exp(exp(median(unlist(lapply(Weibull_param_list5[[1]], function(matrix) matrix[, 2])))) * (10 - 
                               (median(unlist(lapply(Weibull_param_list5[[2]], function(matrix) matrix[, 2])))))^2  + 
                               median(unlist(lapply(Weibull_param_list5[[3]], function(matrix) matrix[, 2])))), 
...
inv.mean.wb.17 <- qqPlot(df.mean.inv.wb$trait[df.mean.inv.wb$T == 17], 
       distribution = "normTrunc", 
       param.list = list(mean = exp(exp(median(unlist(lapply(Weibull_param_list5[[1]], function(matrix) matrix[, 2])))) * (17 - 
                               (median(unlist(lapply(Weibull_param_list5[[2]], function(matrix) matrix[, 2])))))^2  + 
                               median(unlist(lapply(Weibull_param_list5[[3]], function(matrix) matrix[, 2])))), 
                       sd = 1/median(unlist(lapply(Weibull_param_list5[[5]], function(matrix) matrix[, 2]))), 
                       min = 0, 
...
inv.mean.wb.21 <- qqPlot(df.mean.inv.wb$trait[df.mean.inv.wb$T == 21], 
       distribution = "normTrunc", 
       param.list = list(mean = exp(exp(median(unlist(lapply(Weibull_param_list5[[1]], function(matrix) matrix[, 2])))) * (21 - 
                               (median(unlist(lapply(Weibull_param_list5[[2]], function(matrix) matrix[, 2])))))^2  + 
                               median(unlist(lapply(Weibull_param_list5[[3]], function(matrix) matrix[, 2])))), 
                       sd = 1/median(unlist(lapply(Weibull_param_list5[[5]], function(matrix) matrix[, 2]))), 
                       min = 0, 
...
inv.mean.wb.25 <- qqPlot(df.mean.inv.wb$trait[df.mean.inv.wb$T == 25], 
       distribution = "normTrunc", 
       param.list = list(mean = exp(exp(median(unlist(lapply(Weibull_param_list5[[1]], function(matrix) matrix[, 2])))) * (25 - 
                               (median(unlist(lapply(Weibull_param_list5[[2]], function(matrix) matrix[, 2])))))^2  + 
                               median(unlist(lapply(Weibull_param_list5[[3]], function(matrix) matrix[, 2])))), 
                       sd = 1/median(unlist(lapply(Weibull_param_list5[[5]], function(matrix) matrix[, 2]))), 
                       min = 0, 
...
inv.mean.wb.32 <- qqPlot(df.mean.inv.wb$trait[df.mean.inv.wb$T == 32], 
       distribution = "normTrunc", 
       param.list = list(mean = exp(exp(median(unlist(lapply(Weibull_param_list5[[1]], function(matrix) matrix[, 2])))) * (32 - 
                               (median(unlist(lapply(Weibull_param_list5[[2]], function(matrix) matrix[, 2])))))^2  + 
                               median(unlist(lapply(Weibull_param_list5[[3]], function(matrix) matrix[, 2])))), 
                       sd = 1/median(unlist(lapply(Weibull_param_list5[[5]], function(matrix) matrix[, 2]))), 
                       min = 0, 
...
exp.mean.curve.rmse <- data.frame(
  RMSE = c(sqrt(mean((mean.xdf1$med.value.inv - 1/mean.xdf1$true_curve)^2)), 
  sqrt(mean((mean.xdf2$med.value.inv - 1/mean.xdf2$true_curve)^2)), 
  sqrt(mean((mean.xdf3$med.value.inv - 1/mean.xdf3$true_curve)^2)), 
  sqrt(mean((mean.xdf4$med.value.inv - 1/mean.xdf4$true_curve)^2)), 
  sqrt(mean((mean.xdf5$med.value.inv - 1/mean.xdf5$true_curve)^2)))
)
...
wb.mean.curve.rmse <- data.frame(
  RMSE = 
    c(sqrt(mean((mean.xdf1_W$med.value.inv - log(2)/mean.xdf1_W$true_curve)^2)), 
  sqrt(mean((mean.xdf2_W$med.value.inv - log(2)/mean.xdf2_W$true_curve)^2)), 
  sqrt(mean((mean.xdf3_W$med.value.inv - 1/mean.xdf3_W$true_curve)^2)), 
  sqrt(mean((mean.xdf4_W$med.value.inv - 1/mean.xdf4_W$true_curve)^2)), 
  sqrt(mean((mean.xdf5_W$med.value.inv - 1/mean.xdf5_W$true_curve)^2)), 
  sqrt(mean((mean.xdf6_W$med.value.inv - log(2)/mean.xdf6_W$true_curve)^2)))
...
data.rmse.ind.exp <- function(temp, values, a, Topt, c) {
  curve_value <- 1/(exp(median(unlist(lapply(param_list1[[1]], function(matrix) matrix[, 2])))) * (temp - 
    median(unlist(lapply(param_list1[[2]], function(matrix) matrix[, 2]))))^2 + 
    median(unlist(lapply(param_list1[[3]], function(matrix) matrix[, 2]))))
...
data.rmse.mean.exp <- function(temp, values, a, Topt, c) {
  curve_value <- 1/(exp(median(unlist(lapply(param_list2[[1]], function(matrix) matrix[, 2])))) * (temp - 
    median(unlist(lapply(param_list2[[2]], function(matrix) matrix[, 2]))))^2 + 
    median(unlist(lapply(param_list2[[3]], function(matrix) matrix[, 2]))))
  sqrt(mean((values - curve_value)^2))
}
...
data.rmse.inv.exp <- function(temp, values, a, Topt, c) {
  curve_value <- 1/(exp(median(unlist(lapply(param_list3[[1]], function(matrix) matrix[, 2])))) * (temp - 
    median(unlist(lapply(param_list3[[2]], function(matrix) matrix[, 2]))))^2 + 
    median(unlist(lapply(param_list3[[3]], function(matrix) matrix[, 2]))))
  sqrt(mean((values - curve_value)^2))
}
...
data.rmse.mean.inv.exp <- function(temp, values, a, Topt, c) {
  curve_value <- 1/(exp(median(unlist(lapply(param_list4[[1]], function(matrix) matrix[, 2])))) * (temp - 
    median(unlist(lapply(param_list4[[2]], function(matrix) matrix[, 2]))))^2 + 
    median(unlist(lapply(param_list4[[3]], function(matrix) matrix[, 2]))))
  sqrt(mean((values - curve_value)^2))
}
...
data.rmse.inv.mean.exp <- function(temp, values, a, Topt, c) {
  curve_value <- 1/(exp(median(unlist(lapply(param_list5[[1]], function(matrix) matrix[, 2])))) * (temp - 
    median(unlist(lapply(param_list5[[2]], function(matrix) matrix[, 2]))))^2 + 
    median(unlist(lapply(param_list5[[3]], function(matrix) matrix[, 2]))))
  sqrt(mean((values - curve_value)^2))
}
...
data.rmse.ind.wb <- function(temp, values, a, Topt, c) {
  curve_value <- 1/(exp(median(unlist(lapply(Weibull_param_list1[[1]], function(matrix) matrix[, 2])))) * (temp - 
    median(unlist(lapply(Weibull_param_list1[[2]], function(matrix) matrix[, 2]))))^2 + 
    median(unlist(lapply(Weibull_param_list1[[3]], function(matrix) matrix[, 2]))))
  sqrt(mean((values - curve_value)^2))
}
...
data.rmse.mean.wb <- function(temp, values, a, Topt, c) {
  curve_value <- 1/(exp(median(unlist(lapply(Weibull_param_list2[[1]], function(matrix) matrix[, 2])))) * (temp - 
    median(unlist(lapply(Weibull_param_list2[[2]], function(matrix) matrix[, 2]))))^2 + 
    median(unlist(lapply(Weibull_param_list2[[3]], function(matrix) matrix[, 2]))))
  sqrt(mean((values - curve_value)^2))
}
...
data.rmse.inv.wb <- function(temp, values, a, Topt, c) {
  curve_value <- 1/(exp(median(unlist(lapply(Weibull_param_list3[[1]], function(matrix) matrix[, 2])))) * (temp - 
    median(unlist(lapply(Weibull_param_list3[[2]], function(matrix) matrix[, 2]))))^2 + 
    median(unlist(lapply(Weibull_param_list3[[3]], function(matrix) matrix[, 2]))))
  sqrt(mean((values - curve_value)^2))
}
...
data.rmse.mean.inv.wb <- function(temp, values, a, Topt, c) {
  curve_value <- 1/(exp(median(unlist(lapply(Weibull_param_list4[[1]], function(matrix) matrix[, 2])))) * (temp - 
    median(unlist(lapply(Weibull_param_list4[[2]], function(matrix) matrix[, 2]))))^2 + 
    median(unlist(lapply(Weibull_param_list4[[3]], function(matrix) matrix[, 2]))))
  sqrt(mean((values - curve_value)^2))
}
...
data.rmse.inv.mean.wb <- function(temp, values, a, Topt, c) {
  curve_value <- 1/(exp(median(unlist(lapply(Weibull_param_list5[[1]], function(matrix) matrix[, 2])))) * (temp - 
    median(unlist(lapply(Weibull_param_list5[[2]], function(matrix) matrix[, 2]))))^2 + 
    median(unlist(lapply(Weibull_param_list5[[3]], function(matrix) matrix[, 2]))))
  sqrt(mean((values - curve_value)^2))
}
...
data.rmse.wb.wb <- function(temp, values, a, Topt, c) {
  curve_value <- 1/(exp(median(unlist(lapply(Weibull_param_list6[[1]], function(matrix) matrix[, 2])))) * (temp - 
    median(unlist(lapply(Weibull_param_list6[[2]], function(matrix) matrix[, 2]))))^2 + 
    median(unlist(lapply(Weibull_param_list6[[3]], function(matrix) matrix[, 2]))))
  sqrt(mean((values - curve_value)^2))
}
...
rmse.range.df.wb <- data.frame(
  Method = factor(c("Individual WB Data, WB Model", "Individual WB Data, Exp Model", "Mean WB Data, Exp Model", "Individual Inverse WB Data, Trunc Norm Model", 
               "Mean Inverse WB Data, Trunc Norm Model", "Inverse Mean WB Data, Trunc Norm Model")), 
...
rmse.range.comp.df |> ggplot(aes(x = Method, group = Experiment)) +
  geom_linerange(aes(ymin = log(Lower.RMSE), ymax = log(Upper.RMSE), x = Method), position = position_dodge(width = 0.5)) +
  geom_point(aes(y = log(Lower.RMSE), color = "Lower RMSE"), position = position_dodge(width = 0.5)) +
  geom_point(aes(y = log(Upper.RMSE), color = "Upper RMSE"), position = position_dodge(width = 0.5)) +
  geom_point(aes(y = log(Average.RMSE), color = "Average RMSE"), position = position_dodge(width = 0.5)) +
  ...
  labs(color = " ")+
  theme(legend.position = "none")
ggsave("rmse.range.comp.exp.png", width = 8, height = 4)
...
rmse.range.comp.wb.df |> ggplot(aes(x = Method, group = Experiment)) +
  ...
  theme_classic() +
  labs(color = " ")
ggsave("rmse.range.comp.wb.png", width = 8, height = 4)
...
# Weibull PDF and CDF
weibull_pdf <- dweibull(x, shape = 3, scale = my.lambda(10))
weibull_cdf <- pweibull(x, shape = 3, scale = my.lambda(10))

# Plot PDFs
png("pdf.10.png", height = 4.5, width = 6, units = "in", res = 250)
plot(x, exp_pdf, type = "l", col = viridis(3)[2], lwd = 2, ylim = c(0, max(exp_pdf, weibull_pdf)),
     #main = "PDF: Exponential vs Weibull at T=10", 
     ylab = "Density", xlab = "Lifetime")
lines(x, weibull_pdf, col = viridis(3)[1], lwd = 2)
abline(v = 1/f(10))
legend("topright", legend = c("Exponential", "Weibull", "Mean/Median"),
       col = c(viridis(3)[2], viridis(3)[1], "black"), lwd = 2)
dev.off()

# Plot CDFs
png("cdf.10.png", height = 4.5, width = 6, units = "in", res = 250)
plot(x, exp_cdf, type = "l", col = viridis(3)[2], lwd = 2, ylim = c(0, 1),
     #main = "CDF: Exponential vs Weibull at T=10", 
     ylab = "Cumulative Probability", xlab = "Lifetime")
lines(x, weibull_cdf, col = viridis(3)[1], lwd = 2)
abline(v = 1/f(10))
legend("bottomright", legend = c("Exponential", "Weibull", "Mean/Median"),
       col = c(viridis(3)[2], viridis(3)[1], "black"), lwd = 2)
dev.off()

hist(Weibull_data.list[[100]]$trait[Weibull_data.list[[100]]$T == 10])
hist(data.list[[100]]$trait[data.list[[100]]$T == 10])


weibull_data.10 <- Weibull_data.list[[100]]$trait[Weibull_data.list[[100]]$T == 10]
exp_data.10 <- data.list[[100]]$trait[data.list[[100]]$T == 10]
# Create histograms with transparent colors for overlay

png("hist.10.png", height = 4.5, width = 6, units = "in", res = 250)
hist(exp_data.10, breaks = 20, col = adjustcolor(viridis(3)[2], alpha.f = 0.5), 
     xlab = "Lifetime", ylab = "Frequency", main = " ")
hist(weibull_data.10, breaks = 20, col = adjustcolor(viridis(3)[1], alpha.f = 0.5), add = TRUE)
abline(v = 1/f(10), lwd = 2)

# Add a legend
legend("topright", legend = c("Exponential", "Weibull", "Mean/Median"),
       fill = c(adjustcolor(viridis(3)[2], alpha.f = 0.5),
                adjustcolor(viridis(3)[1], alpha.f = 0.5), NA),  # NA for the line
       border = NA,  # No border for the filled boxes
       lty = c(NA, NA, 1),  # Only the third item has a line type
       col = c(NA, NA, "black"),  # Color for the line
       lwd = c(NA, NA, 2))
dev.off()
